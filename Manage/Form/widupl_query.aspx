<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="widupl_query.aspx.cs" Inherits="Manage_Form_MSFTF_query" %>
                ...
                <div class="col-md-12">
                    <div class="box box-danger">
                        <div class="box-header">
                            ...
                            <h1 class="box-title"><b>ERP &gt; 身分證檢查</b> </h1>
                            <div class="box-tools pull-right" data-toggle="tooltip" title="" data-original-title=""></div>
                        </div>
                       <div class="row">
                <div class="col-md-12">
                    <div class="box box-danger">
                       <input id="StartDate" class="datepicker" placeholder="會場日期(開始日)" type="text" />~
                       <input id="EndDate" class="datepicker" placeholder="會場日期(結束日)" type="text" />關鍵字:<input type="text" name="message" placeholder="查尋關鍵字..." id="keyWord"><input type="submit" name="searchwidupl_queryData" class="btn" value="查詢" onclick="searchwidupl_queryData()">
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table width="100%" border="0" cellspacing="0" cellpadding="1">
                            <thead id="">
                                <tr class="bgBlue">
                                    <th class="" style="width: 10%; text-align: center;"></th>
                                    ...
                                    <th class="" style="width: 10%; text-align: center;">電話</th>
                                    <th class="" style="width: 10%; text-align: center;">正面</th>
                                    <th class="" style="width: 10%; text-align: center;">反面</th>
                                    <th class="" style="width: 15%; text-align: center;">修</th>
                                    <th class="" style="width: 15%; text-align: center;">刪</th>
...
　                        <div id="pageBar" style="margin:0 auto;"></div>
    ...
    <script>                                      
        ...
        var CustomerManageHandlerUrl_G = "/Manage/Form/widuplHandler.ashx";
        ...
        //查詢資料==============================================================================start
        //按下[查詢]紐會執行的功能
        var searchwidupl_queryData = function () {
        ...
        var getwiduplquery = function () {
            alert('!!');
            var data = "action=getwiduplData" + "&StartDate=" + val_M("#StartDate") + "&EndDate=" + val_M("#EndDate") + "&keyWord=" + val_M("#keyWord");
        ...
        var startThisPage = function () {
            ...
            onClick_M("#searchwidupl_queryData", getwiduplquery);
            //查詢之功能系結
