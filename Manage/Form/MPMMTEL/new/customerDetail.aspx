...
<body  style="font-family:Microsoft JhengHei;" >
    ...
    <div id="CDDevaluationDialog" class="tabDivMargin startHide form-control" title="自然人評估表-新增">
       <table class="table" >
            ...
            <tr class="">
                ...
                <td class="textAlignLeft" colspan="9"><input class="form-control datepicker cddEmptyCheck" id="CDD_date" itemName="評估日期"/></td>
            </tr>
           <tr class="">
                <td class="textAlignCenter colorGray"><B>政治人員</B></td>
                <td class="textAlignLeft" colspan="9"><select id="OP01" class="form-control"><OPTION value="C">低風險</OPTION><OPTION value="B">一般</OPTION><OPTION value="A">高風險</OPTION></select></td>
            </tr>
           <tr class="">
                <td class="textAlignCenter colorGray"><B>國籍別</B></td>
                <td class="textAlignLeft" colspan="9"><select id="OP02" class="form-control"><OPTION value="C">低風險</OPTION><OPTION value="B">一般</OPTION><OPTION value="A">高風險</OPTION></select></td>
            </tr>
           <tr class="">
                <td class="textAlignCenter colorGray"><B>職業別</B></td>
                <td class="textAlignLeft" colspan="9"><select id="OP03" class="form-control"><OPTION value="C">低風險</OPTION><OPTION value="B">一般</OPTION><OPTION value="A">高風險</OPTION></select></td>
            </tr>
           <tr class="">
                <td class="textAlignCenter colorGray"><B>建立業務管道</B></td>
                <td class="textAlignLeft" colspan="9"><select id="OP04" class="form-control"><OPTION value="C">低風險</OPTION><OPTION value="B">一般</OPTION><OPTION value="A">高風險</OPTION></select></td>
            </tr>
           
            <tr class="">
                <td class="textAlignCenter colorGray"><B>備註</B></td>
                <td class="textAlignLeft" colspan="9"><textarea id="CDD_Note"class="form-control"></textarea></td>
            </tr>
           <tr class="">
               
                <td class="textAlignLeft" colspan="12"><div style="text-align:center" >
    ...
    <!--cdd end-->
    <div id="appointDataDialog" class="tabDivMargin startHide form-control" title="公司資源註記 - 歷史資料 ">
       <table class="table" id="">
            <thead>
    ...
    <div style="margin-right:0 auto;text-align:right;" id="newBtnDiv">
       <span> <table class="table" style="width:60%" id="topTable">
            <tr>
                <td class=" textAlignCenter colorGrayBottom" style="width:5%">ID</td>
                <td class=" textAlignCenter" id="M_SD_tagText" style="width:20%"></td>
                <td class=" textAlignCenter colorGrayBottom" style="width:5%">KYC</td>
                <td class=" textAlignCenter" id="KYC" style="width:12%"></td>
                <td class=" textAlignCenter colorGrayBottom" style="width:5%">CDD</td>
                <td class=" textAlignCenter" id="CDD" style="width:12%"></td>
            </tr>
        </table></span>
        ...
        <button id="" type="button" class="btn btn-primary btn-flat openDiv addPer" openDivName='#addBusinessConnectionDiv'>新增業務聯絡單</button>
    ...
    <div id="addBusinessConnectionDiv" class="tabDivMargin3 divBorder startHide secondDiv">
        <div id="" class="titleBottomBorder marginLeftRight10">
            <h3><span class="colorRed">業務聯絡單-新增</span>
        ...
        <form id="" class="marginLeftRight10 marginTop10px">
            <div class="form-group row ">
                <div class="col-xs-3"><span class="colorRed">*</span>
                    <label for="abcName" class=""><span class="colorRed">*</span>客戶姓名：</label>
                    <br />
                    <select id="abcM_ID" class="form-control" disabled="disabled"></select>
                </div>
                <div class="col-xs-2">
                    <label for="abcConnectType" class=""><span class="colorRed">*</span>聯絡單種類：</label>
                    <br />
                    <select id="abcCF_Item" class="form-control abcCF_Item CF_Item0001EmptyCheck CF_Item0002EmptyCheck CF_Item0003EmptyCheck CF_Item0004EmptyCheck CF_Item0005EmptyCheck CF_Item0006EmptyCheck CF_Item0007EmptyCheck CF_Item0008EmptyCheck CF_Item0009EmptyCheck CF_Item0010EmptyCheck CF_Item0011EmptyCheck" itemName="聯絡單種類"></select>
                </div>
                
                <div class="col-xs-7">
                    <label for="" class=""><span class="colorRed">*</span>簽核主管：</label><br />
                     <span><span class="colorRed">*</span>公司別 &nbsp;:&nbsp; </span>
                    <label class="">
                        <select id="abcU_Com" class="form-control getComIDlistHtmlTagOption comMdepChangeFuc" Com="abcU_Com" MDEP="abcU_MDEP" EMP="abcU_Leader"></select>
                    </label>
                    <span><span class="colorRed">*</span>部門別  &nbsp;:&nbsp; </span>
                    <label class="">
                        <select id="abcU_MDEP" class="form-control getMDEPlistHtmlTagOption comMdepChangeFuc" Com="abcU_Com" MDEP="abcU_MDEP" EMP="abcU_Leader"></select>
                    </label>
                    <span><span class="colorRed">*</span>姓名  &nbsp;:&nbsp; </span>
                    <label class="">
                        <select id="abcU_Leader" class="form-control CF_Item0001EmptyCheck CF_Item0002EmptyCheck CF_Item0003EmptyCheck CF_Item0004EmptyCheck CF_Item0005EmptyCheck CF_Item0006EmptyCheck CF_Item0007EmptyCheck CF_Item0008EmptyCheck CF_Item0009EmptyCheck CF_Item0010EmptyCheck CF_Item0011EmptyCheck" itemName="姓名"></select>
                    </label>
                </div>
            </div>
            <div class="form-group row ">
               <%-- <div id="openConnetTypeDiv0011"  class="openConnetTypeDiv startHide">
                <div class="col-xs-12"></div>
                </div>
                <div id="openConnetTypeDiv0010" class="openConnetTypeDiv startHide">
                    <div class="col-xs-12">
                        <label for="" class=""><span class="colorRed">*</span>是否折讓：</label>
                        <br />
                        <select id="abcC_tag" class="form-control CF_Item0010EmptyCheck" itemName="是否折讓">
                ...
                <div id="openConnetTypeDiv0009" class="openConnetTypeDiv startHide">
                    <div class="col-xs-2">
                        <label for="S_Tag" class=""><span class="colorRed">*</span>暫停/恢復：</label>
                        <br />
                    ...
                    <div class="col-xs-8 " id="abcS_IDandNameDiv">
                        <label for="S_Tag" class="">案件：</label>
                        <br />
                        <select id="abcS_IDandName" class="form-control CF_Item0009EmptyCheck" itemName="案件">
                          <option value="">請選擇</option>
                        </select>
                    </div> 
                    <div class="col-xs-2">
               ...
               <div id="openConnetTypeDiv0008" class="openConnetTypeDiv startHide">
                   <div class="col-xs-8" id="abcB_IDandNameDiv">
                        <label for="S_Tag" class=""><span class="colorRed">*</span>原案件：</label>
                        <br />
                        <select id="abcB_IDandName" class="form-control CF_Item0008EmptyCheck" itemName="原案件">
                          <option value="">請選擇</option>
                        </select>
                   </div> 
                    <div class="col-xs-4">
                        <label class=""><span class="colorRed">*</span>退費金額：</label><br />
                        <input class="form-control  CF_Item0008EmptyCheck" id="abcB_Paymoney" itemName="退費金額"> 
                    </div>
               </div>
               <div id="openConnetTypeDiv0007" class="openConnetTypeDiv startHide">
                    <div class="col-xs-4">
                            <label class=""><span class="colorRed">*</span>選擇會場：</label><br />
                            <select class="form-control CF_Item0007" id="abcV_IDandName" itemName="選擇會場"></select>
                           
                    </div>
                   <div class="col-xs-4">
                            <label class=""><span class="colorRed">*</span>訂金金額：</label><br />
                            <input class="form-control CF_Item0007" id="abcVD_paymoney" itemName="訂金金額"> 
                    </div>
                   <div class="col-xs-4">
                            <label class=""><span class="colorRed">*</span>付款方式：</label><br />
                            <select class="form-control getPayTypeListHtmlTagOption CF_Item0007" id="abcVD_Type" itemName="付款方式"></select>
                    </div>
               </div>
               <div id="openConnetTypeDiv0006" class="openConnetTypeDiv startHide">
                ...
                <div id="openConnetTypeDiv0005" class="openConnetTypeDiv startHide">
                    <div class="col-xs-7">
                        <label for="" class=""><span class="colorRed">*</span>責任助理：</label><br />
                        <span>公司別 &nbsp;:&nbsp; </span>
                        <label class="">
                            <select id="abcU_Agent_Com" class="form-control getComIDlistHtmlTagOption comMdepChangeFuc CF_Item0005" itemName="責任助理" Com="abcU_Agent_Com" MDEP="abcU_Agent_MDEP" EMP="abcU_Agent"></select>
                        </label>
                        <span>部門別  &nbsp;:&nbsp; </span>
                        <label class="">
                            <select id="abcU_Agent_MDEP" class="form-control getMDEPlistHtmlTagOption comMdepChangeFuc CF_Item0005" itemName="部門別" Com="abcU_Agent_Com" MDEP="abcU_Agent_MDEP" EMP="abcU_Agent"></select>
                        </label>
                        <span>姓名  &nbsp;:&nbsp; </span>
                        <label class="">
                            <select id="abcU_Agent" class="form-control CF_Item0005EmptyCheck" itemName="姓名"></select>
                        </label>
                   </div> 
                </div>
                <div id="openConnetTypeDiv0004" class="openConnetTypeDiv startHide">
                    
                    <div class="col-xs-2">
                        <label for="" class=""><span class="colorRed">*</span>月份：</label><br />
                        <select id="abcCmonth" class="form-control CF_Item0004EmptyCheck" itemName="月份">
                            <option value="1">當月</option>
                            <option value="2">次月</option>
                        </select>
                    </div>
                    <div class="col-xs-3">
                        <label for="" class="">其他：</label><br />
                        <input id="abcOther" class="form-control CF_Item0004" itemName="其他"/>
                    </div>
                    <div class="col-xs-7">
                        <label for="" class=""><span class="colorRed">*</span>業績歸屬：</label><br />
                        <span>公司別 &nbsp;:&nbsp; </span>
                        <label class="">
                            <select id="abcAttach_Com" class="form-control getComIDlistHtmlTagOption comMdepChangeFuc CF_Item0004" itemName="公司別" Com="abcAttach_Com" MDEP="abcAttach_MDEP" EMP="abcAttach_User"></select>
                        </label>
                        <span>部門別  &nbsp;:&nbsp; </span>
                        <label class="">
                ...
                <div id="openConnetTypeDiv0003" class="openConnetTypeDiv">
                    <div class="col-xs-6">
                        <label for="" class=""><span class="colorRed">*</span>傳真稿：</label><br />
                        <select id="abcfax" class="form-control CF_Item0003EmptyCheck" itemName="傳真稿">
                            <option value="0002">設-網路傳真</option>
                            <option value="0003">不設</option>
                        </select>
                    </div>
                    <div class="col-xs-6">
                ...
                <div id="openConnetTypeDiv0002" class="openConnetTypeDiv startHide">
                    <div class="col-xs-3">
                        <label for="" class="">設定手機：</label><br />
                        <input id="CellPhone" class="form-control"/>
                    </div>
                    <div class="col-xs-3">
                        <label for="" class=""><span class="colorRed">*</span>設訊：</label><br />
                        <select id="abcMess" class="form-control">
                            <option value="0001">設</option>
                            <option value="0002">不設</option>
                        </select>
                    </div>
                    <div class="col-xs-3">
                        <label for="" class="">&nbsp;</label><br />
                        <select id="abcMess_item" class="form-control">
                    ...
                    <div class="col-xs-3">
                        <label for="" class="">&nbsp;</label><br />
                        &nbsp;<input type="checkbox" name="mess_other3" value="3" class="form-check-input"/>&nbsp;&nbsp;業務自帶&nbsp;&nbsp;
                        <input type="checkbox" name="mess_other4" value="4" class="form-check-input"/>&nbsp;&nbsp;特助或行政帶
                    </div>
                </div>
                <!--CF_Item0001-->
                <div id="openConnetTypeDiv0001" class="openConnetTypeDiv startHide">
                    <div  class="col-xs-12 openConnetTypeDiv0001InnerDIV">
                    <div class="col-xs-3">
                        <span class="colorRed">*</span>入會方式：
                         <label class="">
                    ...
                    <div class="col-xs-3">
                        <label for="" class=""><span class="colorRed">*</span>業績種類：</label><br />
                    ...
                    <div class="col-xs-3">
                        <label for="" class=""><span class="colorRed">*</span>分析師：</label><br />
                        <select id="abcMP_ID" class="form-control  getComIDlistHtmlTagOption comMdepChangeFuc" itemName="分析師">
                        </select>
                    </div>
                    <div class="col-xs-3">
                        <label for="" class=""><span class="colorRed">*</span>會員總類：</label><br />
                        <select id="abcMP_Item" class="form-control getComIDlistHtmlTagOption comMdepChangeFuc" itemName="會員總類">
                            <option value="">請選擇</option>
                        </select>
                    </div>
                    <div class="col-xs-3">
                        <label for="reT_StartDate" class=""><span class="colorRed">*</span>入會日期：</label>
                    ...
                    <div class="col-xs-3">
                        <label for="reT_EndDate" class="">ATM後五碼：</label>
                        <input type="text" class="form-control" id="abcATM">
                    </div>
                        <div class="col-xs-12" style="margin-top:5px;margin-bottom:5px;">
                        <label>電子委任：</label>
                        <span class="displayInlineBlock"><input class="form-control" id="abcca_id" style="width:175px" readonly="readonly"></span> <span class="displayInlineBlock"><button type="button" id="abcgetAppointData">選擇委任資料</button></span>
                    </div>
                         <div class="col-xs-3">
                        <label for="reT_EndDate" class="">設付費影片：</label>
                    ...
                    <div class="col-xs-6">
                        <label for="" class=""><span class="colorRed">*</span>發票資料：</label><br />
                        <span>發票開立方式 &nbsp;:&nbsp; </span>
                        <label class="">
                        ...
                        <span>公司抬頭  &nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
                        <label class="">
                            <input class="form-control abccompany" id="abcCOMNAME"  disabled="disabled"/>
                        </label><br />
                        <span>公司統編  &nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
                        <label class="">
                            <input class="form-control abccompany" id="abcINV_ITEM_UnifyNum" disabled="disabled"/>
                        </label>
                    </div>
                    <div class="col-xs-3">
                        <label for="" class=""><span class="colorRed">*</span>入帳資訊：</label><br />
                        <span>付款類型 &nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
                        <label class="">
                    ...
                    <div class="col-xs-12">
                        <label for="" class="">案件類型：</label><br />
                        <span>類型 &nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                        <label class="">
                            <input class="form-control" id="abctype" value="一般" disabled="disabled"/>
                        </label>
                        <label id="abctype0002" class="startHide abctype">
                            <span>選擇會場 &nbsp;:&nbsp;</span>
                            <label class="">
             
                                <select class="form-control T_Type0002EmptyCheck" id="abcV_ID" itemName="選擇會場"></select>
                            </label>
                            <span>訂金資料 &nbsp;:&nbsp;</span>
                            <label class="">
                                <input class="form-control" id="abcVD" disabled="disabled"/>
                            </label>
                        </label>
                        <div id="abctype0003" class="startHide abctype">
                            <span>入帳人員1 &nbsp;:&nbsp;</span>
                            <label class="">
                                <select class="form-control getMClistHtmlTagOption width160  T_Type0003EmptyCheck"  itemName="入帳人員1" id="abcSpecial1_user"></select>
                            </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <span>入帳人員2 &nbsp;:&nbsp;</span>
                            <label class="">
                                <select class="form-control getMClistHtmlTagOption width160 T_Type0003EmptyCheck" itemName="入帳人員2" id="abcSpecial2_user"></select>
                            </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <span>入帳人員3 &nbsp;:&nbsp;</span>
                            <label class="">
                                <select class="form-control getMClistHtmlTagOption width160"  itemName="入帳人員3" id="abcSpecial3_user"></select>
                            </label><br />
                            <span>入帳金額1 &nbsp;:&nbsp;</span>
                            <label class="">
                                <input class="form-control width160  T_Type0003EmptyCheck"  itemName="入帳金額1" type="number" id="abcT_accountmoney1"/>
                            </label>&nbsp;元&nbsp;
                            
                            <span>入帳金額2 &nbsp;:&nbsp;</span>
                            <label class="">
                                <input class="form-control width160 T_Type0003EmptyCheck" itemName="入帳金額2" type="number" id="abcT_accountmoney2"/>
                            </label>&nbsp;元&nbsp;
                            
                            <span>入帳金額3 &nbsp;:&nbsp;</span>
                            <label class="">
                                <input class="form-control width160" itemName="入帳金額3" type="number" id="abcT_accountmoney3"/>
                            </label>&nbsp;元&nbsp;
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group row ">
                ...
                <div class="col-xs-4">
                    <div style="text-align:center" >
                        <button id="abcSendAddData" type="button" style="height:54px" class="btn btn-primary btn-flat form-control marginTop25">送出新增資料</button>
                    </div>
                </div>
            </div>
        </form>
     ...
     <div id="addPayCashFlowAndAppointSignDialog" class="form-control startHide" title="新增付費&委任簽署">
         ...
         <table class="table">
            <tr>
                ...
                <td class="textAlignLeft M_Name" id="cfasC_Name">
                </td>
            </tr>
             <tr>
                <td class="textAlignCenter">
                ...
                <td class="textAlignLeft"><select id="cfasT_id" class="getAnalystListFuc cfasDataCheckTF" itemid="#cfasmp_item" itemName="分析師"></select>-<select class="cfasDataCheckTF" id="cfasmp_item" itemName="會員種類"><option value=''>請選擇</option></select>
                </td>
            </tr>
             <tr>
                <td class="textAlignCenter">
             ...
             <tr>
                <td class="textAlignCenter" colspan="2">
                   <button id="SendAddcfasDataFuc" type="button" class="btn btn-primary btn-flat form-control">送出新增資料</button>
                </td>
    ...
    <div id="customerDetailTabDiv" class="tabDivMargin3 divBorder">
        <div id="" class="titleBottomBorder marginLeftRight10">
            <h3><span class="colorBlack"><b>客戶資料明細表</b></span>
                <div class="btn-group" data-toggle="btn-toggle"  style="margin-right:0 auto;float: right;">
        ...
        <table  class="table" id="butab">
            ...
            <tr class="">
                ...
                <td class="textAlignLeft" style="width:13%"><img id="Light_Status" light="" style="width:25px;height:25px;" src="" /></td>
                ...
                <td class="textAlignLeft" style="width:13%"><span id="M_Name"></span><span id="noCallImg" class="startHide"><img  light="" style="width:25px;height:25px;" src="../../../img/nocall.jpg" /></span></td>
        ...
        <form id="" class="marginLeftRight10 marginTop10px">
            <div class="form-group row ">
                <div class="col-xs-3">
                    <label for="Light_Status" class="colorBlue">燈號：</label>
                    <label class=""><img id="Light_Status" light="" style="width:25px;height:25px;" src="" /></label>
                </div>
               
                <div class="col-xs-3">
                    <label for="M_Name" class="colorBlue">姓名：</label>
                    <label id="M_Name"></label><label id="noCallImg" class="startHide"><img  light="" style="width:25px;height:25px;" src="../../../img/nocall.jpg" /></label>
                </div>
                 <div class="col-xs-3">
                    <label class="colorBlue">出生日期：</label>
                    <label id="BirthDay_Date"></label>
                </div>
                <div class="col-xs-3">
                    <label class="colorBlue">等級：</label>
                    <label id="M_Grade"></label>
                </div>
            </div>
            <div class="form-group row ">
                <div class="col-xs-3">
                    <label class="colorBlue">手機：</label>
                    <label id="MTel"></label>
                </div>
                <div class="col-xs-3">
                    <label class="colorBlue">業務人員：</label>
                    <label id="MC_Name"></label>
                </div>
                <div class="col-xs-3">
                    <label class="colorBlue">會員編號：</label>
                    <label id="M_Num"></label>
                </div>
                <div class="col-xs-3">
                    <label class="colorBlue">會員密碼：</label>
                    <label id="M_Password"></label>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-xs-3">
                    <label class="colorBlue">住家電話1：</label>
                    <label id="HTel"></label>
                </div>
                <div class="col-xs-3">
                    <label class="colorBlue">住家電話2：</label>
                    <label id="HTel1"></label>
                </div>
                <div class="col-xs-3">
                    <label class="colorBlue">公司電話1：</label>
                    <label id="OTel"></label>
                </div>
                <div class="col-xs-3">
                    <label class="colorBlue">公司電話2：</label>
                    <label id="OTel1"></label>
                </div>
            </div>

            <div class="form-group row">
                <div class="col-xs-3">
                    <label class="colorBlue">傳真1：</label>
                    <label id="Fax"></label>
                </div>
                <div class="col-xs-3">
                    <label class="colorBlue">傳真2：</label>
                    <label id="Fax1"></label>
                </div>
                <div class="col-xs-3">
                    <label class="colorBlue">身分證字號：</label>
                    <label id="M_SD"></label>
                </div>
                <div class="col-xs-3">
                    <label class="colorBlue">電子郵件：</label>
                    <label id="EMail"></label>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-xs-3">
                    <label class="colorBlue">投資金額：</label>
                    <label id="Inv_Money"></label>
                </div>
                <div class="col-xs-3">
                    <label class="colorBlue">詢問之分析師：</label>
                    <label id="Analyst"></label>
                </div>
                <div class="col-xs-3">
                    <label class="colorBlue">詢問之產品：</label>
                    <label id="Product"></label>
                </div>
                <div class="col-xs-3">
                    <label class="colorBlue">電話來源：</label>
                    <label id="Program"></label>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-xs-5">
                    <label class="colorBlue">住家地址：</label>
                    <label id="Haddress"></label>
                </div>
                <div class="col-xs-5">
                    <label class="colorBlue">公司地址：</label>
                    <label id="Oaddress"></label>
                </div>
               <div class="col-xs-2">
                    <label class="colorBlue">郵件收件人：</label>
            ...
            <div class="form-group row">
                <div class="col-xs-4">
                    ...
                    <label id="M_Note"></label>
                </div>
                 <div class="col-xs-4">
                    <label for="N_call_tag" class="colorBlue ">狀態：</label><br />
                    <label class="">派發:<span id="status"></span><br />註記:<span id="tag"></span><span id="longTag"></span><br /><span id="tagHistory"></span></label>
                </div>
                 <div class="col-xs-4">
                    <label class="colorBlue">建檔日期：</label>
                    <label id="add_date"></label>
                </div>
            </div>
        </form>
        -->
    ...
    <div id="eCustomerDetailTabDiv" class="tabDivMargin3 divBorder startHide secondDiv">
        <div id="" class="titleBottomBorder marginLeftRight10">
            <h3><span class="colorRed">客戶資料明細-修改</span>
                <div class="btn-group" data-toggle="btn-toggle"  style="margin-right:0 auto;float: right;">
        ...
        <form id="" class="marginLeftRight10 marginTop10px">
            ...
            <div class="form-group row">
                ...
                <div class="col-xs-3">
                    ...
                    <select id="ecHCity" class="getCityListFuc form-control city sendEditCustomerData ecHCity" CodeNameYN="N" townType="HTown" fieldName="住家地址城市"><option value="">請選擇城市</option></select>
                    <select id="ecHTown" class="town form-control sendEditCustomerData ecHTown" CodeNameYN="Y" fieldName="住家地址區鄉鎮"><option value="">請選擇區鄉鎮</option></select>
                ...
                <div class="col-xs-3">
                    ...
                    <select id="ecOCity" class="getCityListFuc form-control city sendEditCustomerData ecOCity" CodeNameYN="N" townType="OTown" fieldName="公司地址城市"><option value="">請選擇城市</option></select>
                    <select id="ecOTown" class="town form-control sendEditCustomerData ecOTown" CodeNameYN="Y" fieldName="公司地址區鄉鎮"><option value="">請選擇區鄉鎮</option></select>
            ...
            <div class="form-group row">
                ...
                <div class="col-xs-2">
                    ...
                    <select id="ecFax_Zone" class="form-control getZoneCode sendEditCustomerData ecFax_Zone"  CodeNameYN="N" fieldName="傳真1區碼"><option value="">請選擇區碼</option></select>
                ...
                <div class="col-xs-2">
                    ...
                    <select id="ecFax_Zone1" class="form-control getZoneCode sendEditCustomerData ecFax_Zone1"  CodeNameYN="N" fieldName="傳真2區碼"><option value="">請選擇區碼</option></select>
            ...
            <!--<div class="form-group row">
                 <div class="col-xs-3">
                    <label class="">電話來源：</label><br />
                    <select id="ecProgram" class="form-control getProgrmListFuc Required sendEditCustomerData ecProgram"  CodeNameYN="Y" fieldName="電話來源" requiredItem="電話來源"><option value="">請選擇電話來源</option></select>
                   <input type="hidden" class="form-control sendEditCustomerDataHidden ecProgram" CodeName="" id="ecProgramHidden"/>
                </div>
                 <div class="col-xs-2">
                    <label class="">詢問之分析師：</label><br />
                    <select id="ecAnalyst" class="form-control getAnalystListFuc Required sendEditCustomerData ecAnalyst" CodeNameYN="Y" fieldName="詢問之分析師" requiredItem="詢問之分析師"><option value="">請選擇分析師</option></select>
                     <input type="hidden" class="form-control sendEditCustomerDataHidden ecAnalyst" CodeName="" id="ecAnalystHidden"/>
                    <label class="marginTop10px">詢問之產品：</label><br />
                    <select id="ecProduct" class="form-control getProductListFuc Required sendEditCustomerData ecProduct" CodeNameYN="Y" fieldName="詢問之商品" requiredItem="詢問之商品"><option value="">請選擇商品</option></select>
        ...
        <table class="table">
            ...
            <tr class="">
                ...
                <td class="textAlignLeft" colspan="9" style="width:75%">
                    <div  style="text-align:right;margin-bottom:1px;"><button type="button"class="openAddChargeDetailDialog">新增</button></div>
    ...
    <!--舊版 tradeDetailDiv start-->
    <!--
    <div id="tradeDetailDiv" class="tabDivMargin3 divBorder startHide secondDiv">
        <div id="" class="titleBottomBorder marginLeftRight10">
            <h3><span class="colorRed">交易紀錄-詳細資料</span>
                <div class="btn-group" data-toggle="btn-toggle"  style="margin-right:0 auto;float: right;">
                    <button id="" type="button" class="btn closeBtn btn-flat closeDiv" openDivName ="#tradeDetailDiv">X</button>
                </div>
            </h3>
        </div>
        <form id="" class="marginLeftRight10 marginTop10px">
            <div class="form-group row ">
                <div class="col-xs-2">
                    <label for="dT_ID" class="colorBlue">交易編號：</label>
                    <label id="dT_ID"></label>
                </div>
                <div class="col-xs-2">
                    <label for="dT_Status" class="colorBlue">狀態：</label>
                    <label id="dT_Status"></label>
                </div>
                <div class="col-xs-2">
                    <label for="dMP_Name" class="colorBlue">分析師-入會種類：</label>
                    <label id="dMP_Name"></label>
                </div>
                <div class="col-xs-2">
                    <label for="dT_Type" class="colorBlue">入會方式：</label>
                    <label id="dT_Type"></label>
                </div>
                <div class="col-xs-2">
                    <label for="dT_AccountDate" id="AccountType" class="colorBlue"></label>
                    <label id="dT_AccountDate"></label>
                </div>
                <div class="col-xs-2">
                    <label for="dMC" class="colorBlue">入帳人員：</label>
                    <label id="dMC"></label>
                </div>
            </div>
            <div class="form-group row ">
                <div class="col-xs-2">
                    <label for="dT_PayMoney" class="colorBlue">會費：</label>
                    <label id="dT_PayMoney"></label> 
                </div>
                <div class="col-xs-2">
                    <label for="dT_StartDate" class="colorBlue">入會日期：</label>
                    <label id="dT_StartDate"></label>
                </div>
                <div class="col-xs-2">
                    <label for="dT_EndDate" class="colorBlue">到期日期：</label>
                    <label id="dT_EndDate"></label>
                </div>
                <div class="col-xs-2">
                    <label for="" class="colorBlue">剩餘天數/總天數：</label>
                    <label id="days"></label>
                </div>
                <div class="col-xs-2">
                    <label for="dT_Message" class="colorBlue">設訊：</label>
                    <label id="dT_Message"></label>
                </div>
                <div class="col-xs-2">
                    <label for="dT_Fax" class="colorBlue">傳真稿：</label>
                    <label id="dT_Fax"></label>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-xs-6">
                    <label for="dT_Fax" class="colorBlue">收費明細：</label>
                    ...
                    <table class="table" id="chargeDetailTab">
                        ...
                        <tbody id="chargeDetailTb"></tbody>
                    </table>
                </div>
                <div class="col-xs-3">
                    <label for="" class="colorBlue">發票作業：</label><br />
    ...
    <div id="addTradeRecordDetailDiv" class="tabDivMargin3 divBorder startHide secondDiv">
        ...
        <table class="table">
             <tr class="">
                ...
                <td class="textAlignLeft"><select id="atdMP_Name" class="form-control getAnalystListFuc sendAddTradeDetailCheckTF0001 sendAddTradeDetailCheckTF0002 sendAddTradeDetailCheckTF0003" itemId="#atdT_Item" idType="atd" itemName="分析師"></select></td>
                 <td class="textAlignCenter colorGray"><B>入會種類</B></td>
                <td class="textAlignLeft"><select class="form-control sendAddTradeDetailCheckTF0001 sendAddTradeDetailCheckTF0002 sendAddTradeDetailCheckTF0003" itemName="入會種類" id="atdT_Item" ><option value="">請選擇</option></select></td>
                 <td class="textAlignCenter colorGray"><B>入會方式</B></td>
                <td class="textAlignLeft"><select class="form-control T_Type " id="atdT_Type" AccountType="#atdAccountType" normal=".atdnormal"special=".atdspecial" Venue=".atdVenue" VenueID="#atdV_ID" MC="#atdMC"></select></td>
             </tr>
             <tr class="">
                <td class="textAlignCenter colorGray"><B>[<span id="atdAccountType">一般</span>件]入帳</B></td>
                <td class="textAlignLeft" colspan="9"><label class="">
                        <span>入帳時間 : </span>
             ...
             <tr class="">
                ...
                <td class="textAlignLeft" colspan="9"><select class="form-control" id="atdResults_Item"><option value="0001">一般件</option><option value="0002">獎勵件</option></select></td>
             </tr>
            <tr class="">
                <td class="textAlignCenter colorGray"><B>會費</B></td>
                <td class="textAlignLeft" colspan="3"><input type="number" class="form-control sendAddTradeDetailCheckTF0001 sendAddTradeDetailCheckTF0002 sendAddTradeDetailCheckTF003" itemName="會費" id="atdT_PayMoney" /></td>
                <td class="textAlignCenter colorGray"><B>付款方式</B></td>
                <td class="textAlignLeft" colspan="3"> <select class="form-control getPayTypeListHtmlTagOption sendAddTradeDetailCheckTF0001 sendAddTradeDetailCheckTF0002 sendAddTradeDetailCheckTF003" id="atdT_PType" itemName="付款方式"></select></td>
             </tr>
             <tr class="">
                <td class="textAlignCenter colorGray"><B>刷卡末四碼</B></td>
                <td class="textAlignLeft" colspan="9"> <input type="text" id="atdCcard_4Num" class="form-control" placeholder="多張用,分隔"></td>
             </tr>
            <tr class="">
                <td class="textAlignCenter colorGray"><B>入會日期</B></td>
                <td class="textAlignLeft" colspan="3"><input type="text" class="datepicker form-control sendAddTradeDetailCheckTF0001 sendAddTradeDetailCheckTF0002 sendAddTradeDetailCheckTF0003" id="atdT_StartDate" itemName="入會日期"></td>
                <td class="textAlignCenter colorGray"><B>到期日期</B></td>
                <td class="textAlignLeft" colspan="3"><input type="text" class="datepicker form-control sendAddTradeDetailCheckTF0001 sendAddTradeDetailCheckTF0002 sendAddTradeDetailCheckTF0003" id="atdT_EndDate" itemName="到期日期"></td>
             </tr>
             <tr class="">
                <td class="textAlignCenter colorGray"><B>設訊</B></td>
                <td class="textAlignLeft" colspan="9"><label class="checkbox-inline"><input type="checkbox" class="atdT_Message" id="atdT_Message1" value="1" checked>設</label>
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Message" id="atdT_Message2" value="2">不設 </label>
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Message" id="atdT_Message3" value="3">業務自帶</label>
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Message" id="atdT_Message4" value="4">特助或行政帶</label>
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Message" id="atdT_Message5" value="5">設解盤</label>
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Message" id="atdT_Message6" value="6">設特別</label>
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Message" id="atdT_Message7" value="7">設飆股</label>
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Message" id="atdT_Message8" value="8">V1</label>
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Message" id="atdT_Message9" value="9">V2</label>
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Message" id="atdT_Message10" value="10">設專案</label>
                    <input type="hidden" id="atdT_Message" /></td>
             </tr>
            <tr class="">
                <td class="textAlignCenter colorGray"><B>設研究日報</B></td>
                <td class="textAlignLeft" colspan="9"> <label class="checkbox-inline"><input type="checkbox" class="atdT_Fax" id="atdT_Fax1" value="1" disabled="disabled">設</label>
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Fax" id="atdT_Fax2" value="2" checked>設(網路研究日報)</label>
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Fax" id="atdT_Fax3" value="3">不設</label>
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Fax" id="atdT_Fax4" value="4">設解盤 </label>
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Fax" id="atdT_Fax5" value="5">設特別</label>
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Fax" id="atdT_Fax6" value="6">設飆股</label>
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Fax" id="atdT_Fax7" value="7">設專案	</label>
                    <input type="hidden" id="atdT_Fax" /></td>
             </tr>
             <tr class="">
                <td class="textAlignCenter colorGray"><B>XQ軟體帳號</B></td>
                <td class="textAlignLeft" colspan="3"><input type="text" class="form-control" id="atdXQ_SName"></td>
                <td class="textAlignCenter colorGray"><B>XQ軟體密碼</B></td>
                <td class="textAlignLeft" colspan="3"><input type="text" class="form-control" id="atdXQ_SPw"></td>
             </tr>
            <tr class="">
            ...
            <tr class="">
                ...
                <td class="textAlignLeft" colspan="9"><select id="atdBack_intag" class="form-control">
            ...
            <tr class="">
                <td class="textAlignCenter colorGray"><B>備註</B></td>
                <td class="textAlignLeft" colspan="9"><textarea id="atdT_PS"class="form-control"></textarea></td>
             </tr>
            <tr class="">
       ...
       <!-- <form id="" class="marginLeftRight10 marginTop10px">
            <div class="form-group row ">
                ...
                <div class="col-xs-2">
                    <label for="atdMP_Name" class="colorBlue">分析師：</label>
                    <select id="atdMP_Name" class="form-control getAnalystListFuc" itemId="#atdT_Item" idType="atd"></select>
                </div>
                <div class="col-xs-2">
                    <label for="atdT_Item" class="colorBlue">入會種類：</label>
                    <select class="form-control" id="atdT_Item" >
                        <option value="">請選擇</option>
                    </select>
                </div>
                <div class="col-xs-3">
                    <label for="atdT_Type" class="colorBlue">入會方式：</label>
                    <select class="form-control T_Type " id="atdT_Type" AccountType="#atdAccountType" normal=".atdnormal"special=".atdspecial" Venue=".atdVenue" VenueID="#atdV_ID" MC="#atdMC">
                    </select>
                </div>
                <div class="col-xs-2">
                    <label for="atdResults_Item" class="colorBlue">業績種類：</label>
                ...
                <div class="col-xs-3">
                    <label for="atdT_PayMoney" class="colorBlue">會費：</label>
                    <input type="text" class="form-control" id="atdT_PayMoney" />
                </div>
            ...
            <div class="form-group row ">
                ...
                <div class="col-xs-2">
                    <label for="atdT_StartDate" class="colorBlue">入會日期：</label>
                    <input type="text" class="datepicker form-control" id="atdT_StartDate">
                </div>
                <div class="col-xs-2">
                    <label for="atdT_EndDate" class="colorBlue">到期日期：</label>
                    <input type="text" class="datepicker form-control" id="atdT_EndDate">
                </div>
                <div class="col-xs-3">
                    <label for="atdT_PType" class="colorBlue">付款方式：</label>
                    <select class="form-control getPayTypeListHtmlTagOption " id="atdT_PType">
                    </select>
                </div>
                <div class="col-xs-2">
                    <label for="atdCcard_4Num" class="colorBlue">刷卡末四碼：</label>
                    <input type="text" id="atdCcard_4Num" class="form-control" placeholder="多張用,分隔">
                </div>
               
                <div class="col-xs-3">
                    <label for="atdBack_intag" class="colorBlue">委任歸檔：</label>
            ...
            <div class="form-group row ">
                <div class="col-xs-10">
                    <label  class="colorBlue">[<span id="atdAccountType">一般</span>件]入帳 :</label><br />
                    <label class="">
                        <span>入帳時間 : </span>
                        <input type="text" class="datepicker form-control atdnormal atdspecial" id="atdT_AccountDate" style="width:90px;"/>
                    </label>
                    <label class="">
                        <span>入帳人員1：</span>
                        <select id="atdMC" class="form-control getMClistHtmlTagOption atdnormal atdspecial"></select>
                    </label>
                    <label class="">
                        <span>入帳金額1：</span>
                        <input type="text" id="atdT_AccountMoney1" class="form-control atdVenue atdspecial" style="width:90px;" disabled="disabled"/>
                    </label>
                    <label class="">
                        <span>入帳人員2：</span>
                        <select id="atdMC2" class="form-control getMClistHtmlTagOption atdspecial" disabled="disabled"></select>
                    </label> 
                    <label class="">
                        <span>入帳金額2：</span>
                        <input type="text" id="atdT_AccountMoney2" class="form-control atdspecial" style="width:90px;" disabled="disabled"/>
                    </label>
                    <label class="">
                        <span>選擇會場：</span>
                        <select id="atdV_ID" class="form-control atdVenue" disabled="disabled"></select>
                    </label>
                    <label class="">
                        <span>收入類別：</span>
                        <select id="atdT_PayType" class="form-control atdVenue" disabled="disabled">
            ...
            <div class="form-group row">
                <div class="col-xs-5">
                    <label for="eT_Message" class="colorBlue">設訊：</label><br />
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Message" id="atdT_Message1" value="1" checked>設</label>
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Message" id="atdT_Message2" value="2">不設 </label>
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Message" id="atdT_Message3" value="3">業務自帶</label>
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Message" id="atdT_Message4" value="4">特助或行政帶</label>
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Message" id="atdT_Message5" value="5">設解盤</label>
                    ...
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Message" id="atdT_Message9" value="9">V2</label>
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Message" id="atdT_Message10" value="10">設專案</label>
                    <input type="hidden" id="atdT_Message" />
                </div>
                <div class="col-xs-5">
                    <label for="eT_Fax" class="colorBlue">設研究日報：</label><br />
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Fax" id="atdT_Fax1" value="1" disabled="disabled">設</label>
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Fax" id="atdT_Fax2" value="2" checked>設(網路研究日報)</label>
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Fax" id="atdT_Fax3" value="3">不設</label>
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Fax" id="atdT_Fax4" value="4">設解盤 </label>
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Fax" id="atdT_Fax5" value="5">設特別</label>
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Fax" id="atdT_Fax6" value="6">設飆股</label>
                    <label class="checkbox-inline"><input type="checkbox" class="atdT_Fax" id="atdT_Fax7" value="7">設專案	</label>
                    <input type="hidden" id="atdT_Fax" />
                </div>
                <div class="col-xs-2">
                    <label for="eT_Media" class="colorBlue">鎖碼影音：</label><br />
                    <label class="checkbox-inline"><input type="radio" class="atdT_Media" name="atdT_Media" id="atdT_Media1" value="1">設(網站權限)</label>
                    <label class="checkbox-inline"><input type="radio" class="atdT_Media" name="atdT_Media" id="atdT_Media2" value="2">不設</label>
                    <input type="hidden" id="atdT_Media" />
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-xs-5">
                    <label for="" class="colorBlue">備註：</label>
                    <textarea id="atdT_PS"class="form-control"></textarea>
                </div>    
                <div class="col-xs-2">
                    <div style="text-align:center" >
                        <button id="sendAddTradeDetail" style="height:55px;" type="button" class="btn btn-primary btn-flat form-control marginTop25">送出新增交易紀錄資料</button>
    ...
    <div id="editCallRecordDetailDiv" class="tabDivMargin3 divBorder startHide">
        ...
        <form id="" class="marginLeftRight10 marginTop10px">
            <div class="form-group row ">
                ...
                <div class="col-xs-2">
                     <div>
                        <button class="btn btn-primary form-control marginTop25" id="editCallRecordDetailBtn"  onclick="return false;" >送出新增資料</button>
                    </div>
                </div>
            </div>
        </form>
    ...
    <div id="addCallRecordDetailDiv" class="tabDivMargin3 divBorder startHide">
        ...
        <form id="" class="marginLeftRight10 marginTop10px">
            <div class="form-group row ">
                ...
                <div class="col-xs-2">
                     <div>
                        <button class="btn btn-primary form-control marginTop25 blockUI" id="addCallRecordDetailBtn"  onclick="return false;" >送出新增資料</button>
                    </div>
                </div>
            </div>
        </form>
    ...
    <div id="addChargeDetailDialog" class="tabDivMargin startHide form-control" title="入帳金額資料 - 新增">
        <table class="table">
             <tr class="">
                ...
                <td class="textAlignLeft" colspan="9" style="width:75%"><input class="form-control datepicker acdRequired" id="acdAccount_Date" requiredItem="入帳日期"/></td>
             </tr>
            <tr class="">
                <td class="textAlignCenter colorGray" style="width:25%"><B>入賬類別</B></td>
                <td class="textAlignLeft" colspan="9" style="width:75%"><select  class="form-control acdRequired" id="acdPay_tag" requiredItem="入賬類別">
                        <option value="" >請選擇</option>	
            ...
            <tr class="">
                ...
                <td class="textAlignLeft" colspan="9" style="width:75%"><select  class="form-control acdRequired" id="acdT_Com" requiredItem="入賬類別">
                        <option value="HG" >華冠</option>	
                        <option value="TK" >天酷</option>	
                    </select></td>
             </tr>
           <tr class="">
                <td class="textAlignCenter colorGray" style="width:25%"><B>入帳人員</B></td>
                <td class="textAlignLeft" colspan="9" style="width:75%"><select id="acdMC" class="form-control getMClistHtmlTagOption acdRequired" requiredItem="入帳人員"></select></td>
             </tr>
            <tr class="">
                <td class="textAlignCenter colorGray" style="width:25%"><B>入帳金額</B></td>
                <td class="textAlignLeft" colspan="9" style="width:75%"><input type="number" class="form-control acdRequired" id="acdAccount_Money" requiredItem="入帳金額"/></td>
             </tr>
            <tr class="">
                <td class="textAlignCenter colorGray" style="width:25%"><B>入帳方式</B></td>
                <td class="textAlignLeft" colspan="9" style="width:75%"><select  class="form-control getPayTypeListHtmlTagOption acdRequired" id="acdPay_Type" requiredItem="入帳方式"></select></td>
             </tr>
            <tr class="">
                <td class="textAlignCenter" colspan="12"><div style="text-align:center" >
    ...
    <div id="editChargeDetailDialog" class="tabDivMargin startHide form-control" title="入帳金額資料 - 修改">
        ...
        <table class="table">
             ...
             <tr class="">
                <td class="textAlignCenter colorGray" style="width:25%"><B>入帳日期</B></td>
                <td class="textAlignLeft" colspan="9" style="width:75%"><input class="form-control datepicker ecdRequired" id="ecdAccount_Date" requiredItem="入帳日期"/></td>
             </tr>
            <tr class="">
                <td class="textAlignCenter colorGray" style="width:25%"><B>入賬類別</B></td>
                <td class="textAlignLeft" colspan="9" style="width:75%"><select  class="form-control ecdRequired" id="ecdPay_tag" requiredItem="入賬類別">
                        <option value="" >請選擇</option>	
                        <option value="0" >一般件</option>
                        <option value="1" >會場共分</option>	
                        <option value="2" >訂金件</option>		
            ...
            <tr class="">
                <td class="textAlignCenter colorGray" style="width:25%"><B>入帳公司</B></td>
                <td class="textAlignLeft" colspan="9" style="width:75%"><select  class="form-control ecdRequired" id="ecdT_Com" requiredItem="入賬類別">
                        <option value="HG" >華冠</option>	
                        <option value="TK" >天酷</option>	
                    </select></td>
             </tr>
           <tr class="">
                <td class="textAlignCenter colorGray" style="width:25%"><B>入帳人員</B></td>
                <td class="textAlignLeft" colspan="9" style="width:75%"><select id="ecdMC" class="form-control getMClistHtmlTagOption ecdRequired" requiredItem="入帳人員"></select></td>
             </tr>
            <tr class="">
                <td class="textAlignCenter colorGray" style="width:25%"><B>入帳金額</B></td>
                <td class="textAlignLeft" colspan="9" style="width:75%"><input type="number" class="form-control ecdRequired" id="ecdAccount_Money" requiredItem="入帳金額"/></td>
             </tr>
            <tr class="">
                <td class="textAlignCenter colorGray" style="width:25%"><B>入帳方式</B></td>
                <td class="textAlignLeft" colspan="9" style="width:75%"><select  class="form-control getPayTypeListHtmlTagOption ecdRequired" id="ecdPay_Type" requiredItem="入帳方式"></select></td>
             </tr>
            <tr class="">
                <td class="textAlignCenter" colspan="12"><div style="text-align:center" >
    ...
    <div id="normalEditTradeDetailDiv" class="tabDivMargin3 divBorder startHide secondDiv">
        ...
        <table class="table">
             <tr class="">
                ...
                <td class="textAlignLeft" colspan="3"><input class="form-control" id="eT_ID" disabled="disabled"/></td>
                  <td class="textAlignCenter colorGray"><B>狀態</B></td>
                <td class="textAlignLeft" colspan="3"> <input class="form-control" id="eT_Status" disabled="disabled"/></td>
            </tr>
            <tr class="">
                <td class="textAlignCenter colorGray"><B>分析師</B></td>
                <td class="textAlignLeft"><select id="eMP_Name" class="form-control getAnalystListFuc eeditDataCheckTF" itemId="#eT_Item" idType="e" itemName="分析師"></select></td>
                <td class="textAlignCenter colorGray"><B>入會種類</B></td>
                <td class="textAlignLeft"><select class="form-control eeditDataCheckTF" id="eT_Item" itemName="入會種類" ><option value="">請選擇</option></select></td>
                 <td class="textAlignCenter colorGray"><B>入會方式</B></td>
                <td class="textAlignLeft"> <select class="form-control T_Type" id="eT_Type" disabled="disabled"></select></td>
            </tr>
            <tr class="">
                <td class="textAlignCenter colorGray"><B  id="eAccountType"></B></td>
                <td class="textAlignLeft" colspan="3"><input type="text" class="datepicker form-control eeditDataCheckTF" id="eT_AccountDate"  itemName="入帳時間"/></td>
                  <td class="textAlignCenter colorGray"><B>入帳人員</B></td>
                <td class="textAlignLeft" colspan="3"><select id="eMC" class="form-control getMClistHtmlTagOption eeditDataCheckTF"   itemName="入帳人員"></select></td>
            </tr>
            <tr class="">
                
                  <td class="textAlignCenter colorGray"><B>收費明細</B></td>
                <td class="textAlignLeft" colspan="9"><div class="col-xs-12">
             ...
             <tr class="">
                <td class="textAlignCenter colorGray"><B>會費</B></td>
                <td class="textAlignLeft" colspan="3"><input class="form-control eeditDataCheckTF" id="eT_PayMoney" itemname="會費"/></td>
                  <td class="textAlignCenter colorGray"><B>交易燈號</B></td>
                <td class="textAlignLeft" colspan="3"> <select id="eLight_Status" class="form-control">
            ...
            <tr class="">
                ...
                <td class="textAlignLeft" colspan="9"><input type="text" id="eCcard_4Num" class="form-control" placeholder="多張用,分隔"></td>
            </tr>
            <tr class="">
                <td class="textAlignCenter colorGray"><B>入會日期</B></td>
                <td class="textAlignLeft" colspan="3"><input type="text" class="datepicker form-control eeditDataCheckTF"  itemname="入會日期" id="eT_StartDate"></td>
                <td class="textAlignCenter colorGray"><B>到期日期</B></td>
                <td class="textAlignLeft" colspan="3"><input type="text" class="datepicker form-control eeditDataCheckTF"  itemname="到期日期" id="eT_EndDate"></td>
            </tr>
            <tr class="">
                <td class="textAlignCenter colorGray"><B>剩餘天數</B></td>
                <td class="textAlignLeft" colspan="3"><input class="form-control" id="maturityDays" disabled="disabled"/></td>
                <td class="textAlignCenter colorGray"><B>總天數</B></td>
                <td class="textAlignLeft" colspan="3"> <input class="form-control" id="contractDays" disabled="disabled"/></td>
            </tr>
            <tr class="">
                <td class="textAlignCenter colorGray"><B>設訊</B></td>
                <td class="textAlignLeft" colspan="9"><label class="checkbox-inline"><input type="checkbox" class="eT_Message" id="eT_Message1" value="1">設</label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Message" id="eT_Message2" value="2">不設 </label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Message" id="eT_Message3" value="3">業務自帶</label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Message" id="eT_Message4" value="4">特助或行政帶</label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Message" id="eT_Message5" value="5">設解盤</label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Message" id="eT_Message6" value="6">設特別</label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Message" id="eT_Message7" value="7">設飆股</label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Message" id="eT_Message8" value="8">V1</label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Message" id="eT_Message9" value="9">V2</label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Message" id="eT_Message10" value="10">設專案</label>
                    <input type="hidden" id="eT_Message" /></td>
            </tr>
            <tr class="">
                <td class="textAlignCenter colorGray"><B>研究日報</B></td>
                <td class="textAlignLeft" colspan="9"><label class="checkbox-inline"><input type="checkbox" class="eT_Fax" id="eT_Fax1" value="1">設(自取)</label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Fax" id="eT_Fax2" value="2"><a href="#" class="setWebFaxFuc">設(網路傳真)</a></label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Fax" id="eT_Fax3" value="3">不設</label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Fax" id="eT_Fax4" value="4">設解盤 </label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Fax" id="eT_Fax5" value="5">設特別</label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Fax" id="eT_Fax6" value="6">設飆股</label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Fax" id="eT_Fax7" value="7">設專案	</label>
                    <input type="hidden" id="eT_Fax" /></td>
            </tr>
            <tr class="">
                <td class="textAlignCenter colorGray"><B>鎖碼影音</B></td>
                <td class="textAlignLeft" colspan="9"><label class="checkbox-inline"><input type="checkbox" class="eT_Media" id="eT_Media1" value="1"><a href="#" class="setWebFaxFuc">設(網站權限)</a></label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Media" id="eT_Media2" value="2">不設</label>
                    <input type="hidden" id="eT_Media" /></td>
            </tr>
             <tr class="">
                <td class="textAlignCenter colorGray"><B>XQ軟體帳號</B></td>
                <td class="textAlignLeft" colspan="3"><input class="form-control" id="eXQ_SName"/></td>
                 <td class="textAlignCenter colorGray"><B>XQ軟體密碼</B></td>
                <td class="textAlignLeft" colspan="3"><input class="form-control" id="eXQ_SPw"/></td>
            </tr>
            <tr class="">
                <td class="textAlignCenter colorGray"><B>發票作業</B></td>
                <td class="textAlignLeft" colspan="9"><div class="col-xs-5 invoiced">
...
&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;<label class="">
            ...
            <tr class="">
                ...
                <td class="textAlignLeft" colspan="9">
                    <div>
                        <span class="displayInlineBlock"><input class="form-control" id="eca_id" readonly="readonly"/></span>
                        <span class="displayInlineBlock"><button type="button" id="getAppointData">選擇委任資料</button></span>
                    </div>
                    <div>
                        <span class="displayInlineBlock"> <select id="eBack_intag" class="form-control">
                            <option value="0">需委任歸檔</option>
                            <option value="1">不需委任歸檔</option>
                        </select></span>
                        <span class="displayInlineBlock"><label class="">
                        <span>狀態 : </span>
            ...
            <tr class="">
                ...
                <td class="textAlignLeft" colspan="9"> <button type="button" id="openUploadFileDialog">新增文件</button><label id="eFile"></label></td>
            </tr>
            <tr class="">
                <td class="textAlignCenter colorGray"><B>備註</B></td>
                <td class="textAlignLeft" colspan="9"><textarea id="eT_PS"class="form-control"></textarea></td>
            </tr>
            <tr class="">
                <td class="textAlignCenter"colspan="12"><div style="text-align:center">
        ...
        <!--<form id="" class="marginLeftRight10 marginTop10px">
            <div class="form-group row ">
                <div class="col-xs-4">
                    <label for="eT_ID" class="colorBlack">交易編號：</label>
                    <input class="form-control" id="eT_ID" disabled="disabled"/>
                </div>
                <div class="col-xs-2">
                    <label for="eT_Status" class="colorBlack">狀態：</label>
                    <input class="form-control" id="eT_Status" disabled="disabled"/>
                </div>
                <div class="col-xs-2">
                    <label for="eMP_Name" class="colorBlack">分析師：</label>
                    <select id="eMP_Name" class="form-control getAnalystListFuc" itemId="#eT_Item" idType="e"></select>
                </div>
                <div class="col-xs-2">
                    <label for="eT_Item" class="colorBlack">入會種類：</label>
                    <select class="form-control" id="eT_Item" >
                        <option value="">請選擇</option>
                    </select>
                </div>
                <div class="col-xs-2">
                    <label for="eT_Type" class="colorBlack">入會方式：</label>
                    <select class="form-control T_Type" id="eT_Type" disabled="disabled">
            ...
            <div class="form-group row ">
                <div class="col-xs-2">
                    <label for="eT_PayMoney" class="colorBlack">會費：</label>
                    <input class="form-control" id="eT_PayMoney" />
                </div>
                <div class="col-xs-2">
                    <label for="eT_StartDate" class="colorBlack">入會日期：</label>
                    <input type="text" class="datepicker form-control" id="eT_StartDate">
                </div>
                <div class="col-xs-2">
                    <label for="eT_EndDate" class="colorBlack">到期日期：</label>
                    <input type="text" class="datepicker form-control" id="eT_EndDate">
                </div>
                <div class="col-xs-2">
                    <label for="" class="colorBlack">剩餘天數：</label>
                    <input class="form-control" id="maturityDays" disabled="disabled"/>
                </div>
                <div class="col-xs-2">
                    <label for="" class="colorBlack">總天數：</label>
                    <input class="form-control" id="contractDays" disabled="disabled"/>
                </div>
                <div class="col-xs-2">
                    <label for="eT_Message" class="colorBlack">交易燈號：</label>
            ...
            <div class="form-group row ">
                <div class="col-xs-2">
                    <label for="eT_AccountDate" id="eAccountType" class="colorBlack"></label>
                    <input type="text" class="datepicker form-control" id="eT_AccountDate" />
                    <select id="eV_ID" class="form-control"></select>
                </div>
                <div class="col-xs-2">
                    <label for="" class="colorBlack">刷卡末四碼：</label>
                    <input type="text" id="eCcard_4Num" class="form-control" placeholder="多張用,分隔">
                </div>
                <div class="col-xs-3">
                    <label for="eMC" class="colorBlack">入帳人員：</label>
                    <select id="eMC" class="form-control getMClistHtmlTagOption"></select>
                </div>
                
                <div class="col-xs-2">
                    <label for="eBack_intag" class="colorBlack">委任歸檔：</label>
                ...
                <div class="col-xs-3">
                    <label for="eBack_Status" class="colorBlack">歸檔狀態：</label>
                    <select id="eBack_Status" class="form-control"></select>
                </div>
                
            </div>
            <div class="form-group row">
                <div class="col-xs-12">
                    <label for="dT_Fax" class="colorBlack">收費明細：</label>
                    <div style="text-align:right;margin-bottom:3px;">
                        <button id="addChargeDetailBtn" type="button"  class="btn btn-primary btn-flat form-control openDiv openRecordBtn" openDivName='#addChargeDetailDiv' thisId='' ">新增收費明細</button>
                    </div> 
                    <table class="table" id="eChargeDetailTab">
                        <thead class="bgColor">
                            <tr>
                        ...
                        <tbody id="eChargeDetailTb"></tbody>
                    </table>
                </div>
                <div class="col-xs-5 invoiced">
                    <label for="" class="colorBlack">發票作業：</label><br />
                    <label class="">
                        <span>發票號碼 : </span>
                        <label id="eInvoice_num"></label>
                    </label>
...
&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;<label class="">
                ...
                <div class="col-xs-12 unInvoiced">
                    ...
                    <label class="">
                        <span>手開發票號 : </span>
                        <input id="eINV_MNum" style="width:90px" class="form-control"/>
                    </label>
                    <label class="">
                        <span>開立發票 : </span>
                        <select id="eINV_tag" class="form-control">
            ...
            <div class="form-group row">
                <div class="col-xs-5">
                    <label for="eT_Message" class="colorBlack">設訊：</label><br />
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Message" id="eT_Message1" value="1">設</label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Message" id="eT_Message2" value="2">不設 </label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Message" id="eT_Message3" value="3">業務自帶</label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Message" id="eT_Message4" value="4">特助或行政帶</label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Message" id="eT_Message5" value="5">設解盤</label>
                    ...
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Message" id="eT_Message9" value="9">V2</label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Message" id="eT_Message10" value="10">設專案</label>
                    <input type="hidden" id="eT_Message" />
                </div>
                <div class="col-xs-5">
                    <label for="eT_Fax" class="colorBlack">研究日報：</label><br />
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Fax" id="eT_Fax1" value="1">設(自取)</label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Fax" id="eT_Fax2" value="2"><a href="#" class="setWebFaxFuc">設(網路傳真)</a></label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Fax" id="eT_Fax3" value="3">不設</label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Fax" id="eT_Fax4" value="4">設解盤 </label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Fax" id="eT_Fax5" value="5">設特別</label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Fax" id="eT_Fax6" value="6">設飆股</label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Fax" id="eT_Fax7" value="7">設專案	</label>
                    <input type="hidden" id="eT_Fax" />
                </div>
                <div class="col-xs-2">
                    <label for="eT_Media" class="colorBlack">鎖碼影音：</label><br />
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Media" id="eT_Media1" value="1"><a href="#" class="setWebFaxFuc">設(網站權限)</a></label>
                    <label class="checkbox-inline"><input type="checkbox" class="eT_Media" id="eT_Media2" value="2">不設</label>
                    <input type="hidden" id="eT_Media" />
                </div>

            </div>
            <div class="form-group row">
                <div class="col-xs-5">
                    <label for="" class="colorBlack">歷史備註：</label>
                    <textarea id="eHistoryT_PS"class="form-control"  disabled="disabled"></textarea>
                </div>
                
                <div class="col-xs-5">
                    <label for="" class="colorBlack">備註：</label>
                    <textarea id="eT_PS"class="form-control"></textarea>
                </div>    
                <div class="col-xs-2">
                    <div style="text-align:center" >
                        <button id="sendNormalEditData" style="height:55px;" type="button" class="btn btn-primary btn-flat form-control marginTop25">送出一般修正資料</button>
                    </div>  
                </div>
            </div>
        </form>-->
    ...
    <!--新版 交易紀錄-續約修改 start-->
     <div id="renewalEditTradeDetailDialog" class="tabDivMargin startHide form-control" title="交易紀錄-續約修改">
        <table class="table">
            <tr class="">
                <td class="textAlignCenter colorGray"><B>交易編號</B></td>
                <td class="textAlignLeft" colspan="9"><input class="form-control" id="reT_ID" disabled="disabled"/></td>
            </tr>
            <tr class="">
                <td class="textAlignCenter colorGray"><B>分析師</B></td>
                <td class="textAlignLeft"><select id="reMP_Name" class="form-control getAnalystListFuc reeditDataCheckTF0001 reeditDataCheckTF0002 reeditDataCheckTF0003" itemId="#reT_Item" idType="re" itemname="分析師"></select></td>
                 <td class="textAlignCenter colorGray"><B>入會種類</B></td>
                <td class="textAlignLeft"> <select class="form-control  reeditDataCheckTF0001 reeditDataCheckTF0002 reeditDataCheckTF0003" id="reT_Item" itemname="入會種類">
                        
                    </select></td>
                 <td class="textAlignCenter colorGray"><B>入會方式</B></td>
                <td class="textAlignLeft"><select class="form-control T_Type" id="reT_Type" AccountType="#reAccountType" normal=".normal"special=".special" Venue=".Venue" VenueID="#reV_ID">
                        </select></td>
             </tr>
             <tr class="">
            ...
            <tr class="">
                <td class="textAlignCenter colorGray"><B>會費</B></td>
                <td class="textAlignLeft" colspan="3"><input class="form-control reeditDataCheckTF0001 reeditDataCheckTF0002 reeditDataCheckTF0003" id="reT_PayMoney"  itemname="會費"/></td>
                <td class="textAlignCenter colorGray"><B>付款方式</B></td>
                <td class="textAlignLeft" colspan="3"> <select class="form-control getPayTypeListHtmlTagOption reeditDataCheckTF0001 reeditDataCheckTF0002 reeditDataCheckTF0003" itemname="付款方式" id="reT_PType"></select></td>
             </tr>
             
            <tr class="">
                <td class="textAlignCenter colorGray"><B>入會日期</B></td>
                <td class="textAlignLeft" colspan="3"><input type="text" class="datepicker form-control  reeditDataCheckTF0001 reeditDataCheckTF0002 reeditDataCheckTF0003"itemname="入會日期"  id="reT_StartDate"></td>
                <td class="textAlignCenter colorGray"><B>到期日期</B></td>
                <td class="textAlignLeft" colspan="3"><input type="text" class="datepicker form-control  reeditDataCheckTF0001 reeditDataCheckTF0002 reeditDataCheckTF0003"itemname="到期日期" id="reT_EndDate"></td>
             </tr>
             <tr class="">
                <td class="textAlignCenter colorGray" ><B>設訊</B></td>
                <td class="textAlignLeft"  colspan="3"><select id="reT_Message" class="form-control">
                        <option value="1">設訊</option>
                        <option value="2">不設</option>
                    </select></td>
                 <td class="textAlignCenter colorGray"><B>傳真稿</B></td>
                <td class="textAlignLeft"  colspan="3"><select id="reT_Fax" class="form-control">
            ...
            <tr class="">
                <td class="textAlignCenter colorGray"><B>備註</B></td>
                <td class="textAlignLeft" colspan="9"><textarea id="reT_PS"class="form-control"></textarea></td>
             </tr>
            <tr class="">
    ...
    <!--新版 交易紀錄-續約修改 end-->
    <!--舊版 交易紀錄-續約修改 start-->
    <!--<div id="renewalEditTradeDetailDiv" class="tabDivMargin3 divBorder startHide secondDiv">
        <div id="" class="titleBottomBorder marginLeftRight10">
            <h3><span class="colorRed">交易紀錄-續約修改</span>
                <div class="btn-group" data-toggle="btn-toggle"  style="margin-right:0 auto;float: right;">
                    <button id="" type="button" class="btn closeBtn btn-flat closeDiv" openDivName ="#renewalEditTradeDetailDiv">X</button>
                </div>
            </h3>
        </div>
        <form id="" class="marginLeftRight10 marginTop10px">
            <div class="form-group row ">
                <div class="col-xs-6">
                    <label for="reT_ID" class="colorBlue">交易編號：</label>
                        <input class="form-control" id="reT_ID" disabled="disabled"/>
                </div>
                <div class="col-xs-2">
                    <label for="reMP_Name" class="colorBlue">分析師：</label>
                    <select id="reMP_Name" class="form-control getAnalystListFuc" itemId="#reT_Item" idType="re"></select>
                </div>
                <div class="col-xs-2">
                    <label for="reT_Item" class="colorBlue">入會種類：</label>
                    <select class="form-control" id="reT_Item">
                        
                    </select>
                </div>
                <div class="col-xs-2">
                    <label for="reT_Type" class="colorBlue">入會方式：</label>
            ...
            <div class="form-group row">
                <div class="col-xs-2">
                   <label for="reT_PayMoney" class="colorBlue">會費：</label>
                    <input class="form-control" id="reT_PayMoney" />
                </div>
                <div class="col-xs-2">
                    <label for="reT_PType" class="colorBlue">付款方式：</label>
                    <select class="form-control getPayTypeListHtmlTagOption" id="reT_PType"></select>
                </div>
                <div class="col-xs-2">
                    <label for="reT_StartDate" class="colorBlue">入會日期：</label>
                    <input type="text" class="datepicker form-control" id="reT_StartDate">
                </div>
                <div class="col-xs-2">
                    <label for="reT_EndDate" class="colorBlue">到期日期：</label>
                    <input type="text" class="datepicker form-control" id="reT_EndDate">
                </div>
                <div class="col-xs-2">
                    <label for="reT_Message" class="colorBlue">設訊：</label><br />
                ...
                <div class="col-xs-2">
                    <label for="reT_Fax" class="colorBlue">傳真稿：</label><br />
            ...
            <div class="form-group row ">
                <div class="col-xs-10">
                    ...
                    <label class="">
                        <span>開立日期 : </span>
                        <input type="text" class="datepicker form-control"  id="reINV_Createdate">                   
                    </label>
                    <label class="">
                        <span>發票種類 : </span>
                        <select id="reINV_Item" class="form-control INV_ItemSelect" companyClassName=".recompany">
                            <option value="1">二聯</option>
                            <option value="2">三聯</option>
                        </select>
                    </label>
                    <label class="">
                        <span>開立公司 : </span>
                        <select id="reINV_COM" class="form-control" ></select>
                    </label>
                    <label class="">
                        <span>發票號碼 : </span>
                        <select id="reInv_Num" class="form-control"></select>
                    </label>
                    <label class="">
                        <span>寄發狀況 : </span>
                        <select id="reINV_SendState" class="form-control">
                    ...
                    <label class="">
                        <span>公司抬頭 : </span>
                        <input type="text" id="reINV_ComName" class="form-control recompany"  disabled="disabled"/>
                    </label>
                    <label class="">
                        <span>公司統編 : </span>
                        <input type="text" id="reINV_UnifyNum" class="form-control recompany"  disabled="disabled"/>
                    </label> 
                </div>
               <div class="col-xs-2">
                    <label for="" class="colorBlue">備註：</label>
                    <textarea id="ReT_PS"class="form-control"></textarea>
                </div>
            </div>
            <div class="form-group row ">
                <div class="col-xs-10">
                    <label  class="colorBlue">[<span id="reAccountType">一般</span>件]入帳 :</label><br />
                    <label class="">
                        <span>入帳時間 : </span>
                        <input type="text" class="datepicker form-control normal special" id="reT_AccountDate" style="width:90px;"/>
                    </label>
                    <label class="">
                        <span>入帳人員1：</span>
                        <select id="reMC" class="form-control getMClistHtmlTagOption normal special"></select>
                    </label>
                    <label class="">
                        <span>入帳金額1：</span>
                        <input type="number" id="reT_AccountMoney1" class="form-control special" style="width:90px;" disabled="disabled"/>
                    </label>
                    <label class="">
                        <span>入帳人員2：</span>
                        <select id="reMC2" class="form-control getMClistHtmlTagOption special" disabled="disabled"></select>
                    </label> 
                    <label class="">
                        <span>入帳金額2：</span>
                        <input type="number" id="reT_AccountMoney2" class="form-control special" style="width:90px;" disabled="disabled"/>
                    </label>
                    <label class="">
                        <span>選擇會場：</span>
                        <select id="reV_ID" class="form-control Venue" disabled="disabled"></select>
                    </label>
                    <label class="">
                        <span>收入類別：</span>
                        <select id="reT_PayType" class="form-control Venue" disabled="disabled">
                ...
                <div class="col-xs-2">
                    <div style="text-align:center" >
                        <br />
                        <button id="reSendEditData" type="button" class="btn btn-primary btn-flat form-control marginTop25">送出續約修正資料</button>
                    </div>
                </div>
            </div>
        </form>
    ...
    <div id="stopEditTradeDetailDialog" class="tabDivMargin startHide form-control" title="交易紀錄-暫停修改">
       <table class="table" >
            ...
            <tr class="">
                <td class="textAlignCenter colorGray"><B>交易編號</B></td>
                <td class="textAlignLeft" colspan="9"><input class="form-control" id="seT_ID" disabled="disabled"/></td>
            </tr>
           <tr class="">
                <td class="textAlignCenter colorGray"><B>暫停日期</B></td>
                <td class="textAlignLeft" colspan="9"><input class="form-control datepicker seeditDataCheckTF" id="seT_PauseDate" itemname="暫停日期"/></td>
            </tr>
            <tr class="">
                <td class="textAlignCenter colorGray"><B>歷史備註</B></td>
                <td class="textAlignLeft" colspan="9"><textarea id="seHistoryT_PS"class="form-control" disabled="disabled"></textarea></td>
            </tr>
            <tr class="">
                <td class="textAlignCenter colorGray"><B>備註</B></td>
                <td class="textAlignLeft" colspan="9"><textarea id="seT_PS"class="form-control"></textarea></td>
            </tr>
           <tr class="">
    ...
    <div id="restoreEditTradeDetailDialog" class="tabDivMargin startHide form-control" title="交易紀錄 - 恢復會期 ">
       <table class="table" >
            ...
            <tr class="">
                <td class="textAlignCenter colorGray"><B>交易編號</B></td>
                <td class="textAlignLeft" colspan="9"><input class="form-control" id="reseT_ID" disabled="disabled"/></td>
            </tr>
           <tr class="">
                <td class="textAlignCenter colorGray"><B>原會期(始)</B></td>
                <td class="textAlignLeft" colspan="9"><input class="form-control"  id="reseT_StartDate" disabled="disabled"/></td>
            </tr>
           <tr class="">
                <td class="textAlignCenter colorGray"><B>原會期(終)</B></td>
                <td class="textAlignLeft" colspan="9"><input class="form-control" id="reseT_EndDate" disabled="disabled"/></td>
            </tr>
           <tr class="">
                <td class="textAlignCenter colorGray"><B>暫停日期</B></td>
                <td class="textAlignLeft" colspan="9"><input class="form-control"  id="reseT_PauseDate" disabled="disabled"/></td>
            </tr>
           <tr class="">
                <td class="textAlignCenter colorGray"><B>剩餘天數</B></td>
                <td class="textAlignLeft" colspan="9"><input class="form-control" id="reseT_PauseDateDays" disabled="disabled"/></td>
            </tr>
           <tr class="">
                <td class="textAlignCenter colorGray"><B>恢復日期</B></td>
                <td class="textAlignLeft" colspan="9"><input  class="datepicker form-control reseeditDataCheckTF" id="reseT_RestDate" itemname="恢復日期"/></td>
            </tr>
           <tr class="">
                <td class="textAlignCenter colorGray"><B>新到期日</B></td>
                <td class="textAlignLeft" colspan="9"><input   class="datepicker form-control reseeditDataCheckTF" id="reseNewT_EndDate" itemname="新到期日"/></td>
            </tr>
            <tr class="">
                <td class="textAlignCenter colorGray"><B>歷史備註</B></td>
                <td class="textAlignLeft" colspan="9"><textarea id="reseHistoryT_PS"class="form-control" disabled="disabled"></textarea></td>
            </tr>
           <tr class="">
                <td class="textAlignCenter colorGray"><B>備註</B></td>
                <td class="textAlignLeft" colspan="9"><textarea id="reseT_PS"class="form-control"></textarea></td>
            </tr>
        ...
        <table class="table">
            <thead >
                <tr class="marginTop5px bgColor">
                    ...
                    <th class="textAlignCenter width5Per leftSideWhite">
                       信封
                    </th>
                    <th class="textAlignCenter width5Per leftSideWhite">
                       CDD
                    </th>
                    <th class="textAlignCenter width15Per leftSideWhite">
                       修
                    </th>
                    <th class="textAlignCenter width5Per leftSideWhite">
                       刪
   ...
   <script src="<%=getRelativePath()%>js/tool/tool.js" type="text/javascript"></script>
     <script>
         ...
         */
         ...
         var ERPcustomerWebPayMENU_no_G = "<%=getERPcustomerWebPayMENU_no()%>";
         ...
         var getEditCustomerDataSuccess = function (back) {
             ...
             $(".ecN_Call_tag").val(json[0].N_Call_tag);
             $("#ecN_Call_tagHidden").attr("CodeName", $Common.Code.deCode("N_Call_tag", json[0].N_Call_tag));
             //詢問之商品
         ...
         var startThisPage = function () {
             ...
             getCustomerData(getDetailCustomerDataSuccess);//開始頁面執行這邊!!!
         ...
         var openAddBusinessConnectionDiv = function () {
             blockUI_M();
             hide_M("#customerTabDiv");
             show_M("#addBusinessConnectionDiv");
             //$('#addBusinessConnectionDiv').dialog("open");
             alert('開啟新增業務聯絡單視窗');
             //取得公司option
             ...
             //        switch (thisVal) {
             //            case "0009":
             //                sb = new string_M.StringBuilder();

             //                $.each(TradeRecordListJson_G, function (i, v) {
             //                    sb.append("<option value='");
             //                    sb.append(v.T_ID);
             //                    sb.append("' S_ID='");
             //                    sb.append(v.T_ID);
             ...
             //                });
             //                $("#abcS_IDandName").append(sb.toString());


             //                $("#abcSSdate_Date").val(Today_G);
             //                break;
             //            case "0008":
             //                sb = new string_M.StringBuilder();
             //                $.each(TradeRecordListJson_G, function (i, v) {
             ...
             //                    sb.append(getMoneyFormat_M(v.T_PayMoney));
             //                });
             //                $("#abcB_IDandName").append(sb.toString());

             //                break;
             //            case "0007":
             //                $Common.MVENU.getVenueListHtmlTagOption(CommonHandlerUrl_M, "#abcV_IDandName");
             //                break;
             //            case "0006":
             //                sb = new string_M.StringBuilder();
             ...
             //                    sb.append(getMoneyFormat_M(v.T_PayMoney));
             //                });
             //                $("#abcT_IDandName").append(sb.toString());
             //                var afterSuccessFuc = function () {
             //                    $("#abcD_MP").on("change", function () {
             //                        var type = $(this).val();
             //                        $Common.MITEM.getListHtmlTagOption(CommonHandlerUrl_M, "#abcD_Item", type, "option")
             //                    });
             //                };
             //                $Common.MUSER.getAnalystListHtmlTagOption(CommonHandlerUrl_M, "#abcD_MP", ComID_G,"option", afterSuccessFuc);
             //                break;
             //            case "0005":
             //                getMCdata("UA", MC_G);
             ...
             //                break;
             //            case "0003":
             //                $("#abcfax").on("change", function () {
             //                    var thisVal = $(this).val();
             //                    if (thisVal == "0002") {
             //                        disabledFalse_M("#abcfax_item");
             //                    } else {
             //                        disabledTrue_M("#abcfax_item");
             //                    }
             //                });
             //                break;
             //            case "0002":
             //                $("#abcmess").unbind();
             //                $("#abcmess").on("change", function () {
             //                    var thisVal = $(this).val();
             //                    if (thisVal == "1") {
             //                        disabledFalse_M("#abcmess_item");
             //                    } else {
             //                        disabledTrue_M("#abcmess_item");
             //                    }
             //                });
             //                break;
             //            case "0001":
             ...
             //                var afterSuccessFuc = function () {
             //                    $("#abcMP_ID").on("change", function () {
             //                        var type = $(this).val();
             //                        $Common.MITEM.getListHtmlTagOption(CommonHandlerUrl_M, "#abcMP_Item", type,"option");
             //                    });
             //                };
             //                $Common.MUSER.getAnalystListHtmlTagOption(CommonHandlerUrl_M, "#abcMP_ID", ComID_G,"option" ,afterSuccessFuc);

             //                $("#abcPT_Item").on("change", function () {
             //                    var type = $(this).val();
             //                    if (type == "1") {
             //                        disabledTrue_M("#abcPaymoney2");
             //                        disabledTrue_M("#abcT_PType2");
             //                        disabledTrue_M("#abcPaymoney1");
             //                        disabledTrue_M("#abcT_PType1");
             //                    } else {
             //                        disabledFalse_M("#abcPaymoney2");
             //                        disabledFalse_M("#abcT_PType2");
             //                        disabledFalse_M("#abcPaymoney1");
             //                        disabledFalse_M("#abcT_PType1");
             //                    }
             //                });
             //                //取得會場資料
             //                $Common.MVENU.getVenueListHtmlTagOption(CommonHandlerUrl_M, "#abcV_ID");
             //                //取得訂金資料
             //                getDownpayment();
             //                $("#abcSpecial2_user").val("");
             //                $("#abcSpecial3_user").val("");
             //                $("#abcT_Type").on("change", function () {
             //                    $("#abctype").empty();
             //                    var type = $(this).val();

             //                    var typeName = $('#abcT_Type :selected').text();
             //                    $("#abctype").val(typeName);
             //                    $(".abctype").hide();
             //                    $("#abctype" + type).show();
             ...
             //                break;
             //        }
             //        $(".openConnetTypeDiv").hide();
             //        if (thisVal == "0001") {
             //            $("#openConnetTypeDiv" + thisVal).show();
             //            $("#openConnetTypeDiv0002").show();
             //            $("#openConnetTypeDiv0003").show();
             //        } else {
             //            $("#openConnetTypeDiv" + thisVal).show();
             //        }
             ...
             //};
             //$Common.MITEM.getListHtmlTagOption(CommonHandlerUrl_M, ".abcCF_Item", "MCOTF", "option",afterSuccessFuc);
         ...
         var openDiv = function (openDivName, thisId, type) {
             ...
             switch (openDivName) {
                 ...
                 case "#addBusinessConnectionDiv":
                     //alert('addBusinessConnectionDiv');
                     blockUI_M();
                     show_M("#addBusinessConnectionDiv");
         ...
         var addBusinessConnection = function () {
             ...
             switch (CF_Item) {
                 ...
                 case "0011":
                     ...
                     if (goAjax) {
                         data = "M_ID=" + M_ID_G + "&CF_Item=" + CF_Item + "&U_Leader=" + U_Leader + "&U_LeaderName=" + U_LeaderName + "&Obj=" + Obj + "&F_Status=1&PS=" + PS + "&add_user=" + U_Num_M + "&add_com=" + ComID_G + "&add_ip=" + IP_G + "&U_LeaderCom=" + U_LeaderCom + "&action=addBusinessConnection";
                     }
                     break;
                 ...
                 case "0010":
                     ...
                     if (goAjax) {
                         data = "M_ID=" + M_ID_G + "&CF_Item=" + CF_Item + "&C_tag=" + C_tag + "&U_Leader=" + U_Leader + "&U_LeaderName=" + U_LeaderName + "&Obj=" + Obj + "&F_Status=1&PS=" + PS + "&add_user=" + U_Num_M + "&add_com=" + ComID_G + "&add_ip=" + IP_G + "&U_LeaderCom=" + U_LeaderCom + "&action=addBusinessConnection";
                     }
                 ...
                 case "0009":
                     ...
                     if (goAjax) {
                         var S_tag = val_M("#abcS_Tag");
                         var S_ID = val_M("#abcS_IDandName");
                         var S_Name = attr_M("#abcS_IDandName :selected", "S_Name");
                         var SSDate = val_M("#abcSSdate_Date");
                         data = "M_ID=" + M_ID_G + "&CF_Item=" + CF_Item + "&S_tag=" + S_tag + "&S_ID=" + S_ID + "&S_Name=" + S_Name + "&SSDate=" + SSDate + "&U_Leader=" + U_Leader + "&U_LeaderName=" + U_LeaderName + "&U_LeaderCom=" + U_LeaderCom + "&Obj=" + Obj + "&F_Status=1&PS=" + PS + "&add_user=" + U_Num_M + "&add_com=" + ComID_G + "&add_ip=" + IP_G + "&action=addBusinessConnection";
                     }
                 ...
                 case "0008":
                     ...
                     if (goAjax) {
                         var B_ID = val_M("#abcB_IDandName");
                         var B_Name = attr_M("#abcB_IDandName :selected", "B_Name");
                         var B_Paymoney = val_M("#abcB_Paymoney");
                         data = "M_ID=" + M_ID_G + "&CF_Item=" + CF_Item + "&B_Paymoney=" + B_Paymoney + "&B_ID=" + B_ID + "&B_Name=" + B_Name + "&U_Leader=" + U_Leader + "&U_LeaderName=" + U_LeaderName + "&U_LeaderCom=" + U_LeaderCom + "&Obj=" + Obj + "&F_Status=1&PS=" + PS + "&add_user=" + U_Num_M + "&add_com=" + ComID_G + "&add_ip=" + IP_G + "&action=addBusinessConnection";
                     }
                 ...
                 case "0006":
                     ...
                     if (goAjax) {
                         ...
                         var D_Type = val_M("#abcD_Type");//付款方式
                         var D_Paymoney = val_M("#abcD_Paymoney");//補件金額
                         var D_tag = val_M("#abcD_tag");//是否補件
                         var DSdate = val_M("#abcDSdate_Date");//新會期(始)
                         var DEdate = val_M("#abcDEdate_Date");//新會期(終)
                 ...
                 case "0005":
                     ...
                     if (goAjax) {
                         ...
                         data = "M_ID=" + M_ID_G + "&CF_Item=" + CF_Item + "&U_Agent=" + U_Agent + "&U_Agent_Name=" + U_Agent_Name + "&U_Agent_Com=" + U_Agent_Com + "&U_Leader=" + U_Leader + "&U_LeaderName=" + U_LeaderName + "&Obj=" + Obj + "&F_Status=1&PS=" + PS + "&add_user=" + U_Num_M + "&add_com=" + ComID_G + "&add_ip=" + IP_G + "&U_LeaderCom=" + U_LeaderCom + "&action=addBusinessConnection";
                     }
                 ...
                 case "0004":
                     ...
                     if (goAjax) {
                         var Attach_User = $("#abcAttach_User").val();
                         var Attach_Name = $("#abcAttach_User :selected").text();
                         var Attach_Com = $("#abcAttach_Com").val();
                         var CMonth = $("#abcCmonth").val();
                         var Other = $("#abcOther").val();
                         data = "M_ID=" + M_ID_G + "&CF_Item=" + CF_Item + "&Attach_User=" + Attach_User + "&Attach_Name=" + Attach_Name + "&Attach_Com=" + Attach_Com + "&CMonth=" + CMonth + "&Other=" + Other + "&U_Leader=" + U_Leader + "&U_LeaderName=" + U_LeaderName + "&Obj=" + Obj + "&F_Status=1&PS=" + PS + "&add_user=" + U_Num_M + "&add_com=" + ComID_G + "&add_ip=" + IP_G + "&U_LeaderCom=" + U_LeaderCom + "&action=addBusinessConnection";
                     }
                 ...
                 case "0003":
                     ...
                     if (goAjax) {
                         ...
                         data = "M_ID=" + M_ID_G + "&CF_Item=" + CF_Item + "&Fax=" + Fax + "&U_Leader=" + U_Leader + "&U_LeaderName=" + U_LeaderName + "&Obj=" + Obj + "&F_Status=1&PS=" + PS + "&add_user=" + U_Num_M + "&add_com=" + ComID_G + "&add_ip=" + IP_G + "&U_LeaderCom=" + U_LeaderCom + "&action=addBusinessConnection";
                     }
                 ...
                 case "0002":
                     ...
                     var Mess_item = $("#abcMess_item").val();//設訊(項目)
                 ...
                 case "0001":
                     ...
                     if (goAjax) {
                         var Fax = $("#abcfax").val();//傳真稿
                         if (Fax == "0002") {
                             Fax = "2";
                         } else {
                             Fax = "3";
                         }
                         var fax_item = $("#abcfax_item").val();//傳真稿(項目)
                         if (fax_item != "2") {
                             Fax += ",";
                             Fax += fax_item;
                         }
                         var Mess = $("#abcMess").val();//設訊
                         if (Mess == "0002") {
                             Mess = "2";
                         } else {
                             Mess = "1";
                         ...
                         var MP_ID = $("#abcMP_ID").val();//分析師
                         var MP_Item = $("#abcMP_Item").val();//(分析師)會員種類
                         var T_Type = $("#abcT_Type").val();//入會方式
                         var Results_Item = $("#abcResults_Item").val();//業績種類
                         var Paymoney = $("#Paymoney").val();//會費(入帳資訊)[單筆]
                         var Paymoney1 = $("#abcPaymoney1").val();//金額1[多筆]
                         var Paymoney2 = $("#abcPaymoney2").val();//金額2[多筆]
                         var T_PType = $("#abcT_PType").val();//付款方式
                         var T_PType1 = $("#abcT_PType1").val();//付款方式1
                         var T_PType2 = $("#abcT_PType2").val();//付款方式2
                         var T_Type = $("#abcT_Type").val();//入會方式
                         var PT_Item = val_M("#abcPT_Item");
                         var PT_Item = $("#abcPT_Item").val();//付款類型
                         var CCard_4Num = $("abcCCard_4Num").val();//信用卡末四碼
                         var Special1_user = $("#abcSpecial1_user").val();//入帳人員1
                         var Special1_userName = (($("#abcSpecial1_user :selected").text()).split("-"))[0];
                         var Special1_usercom = $("#abcSpecial1_user :selected").attr("comid");
                         if (Special1_user == "") {
                             Special1_userName = "";
                             Special1_usercom = "";
                         }
                         var Special2_user = $("#abcSpecial2_user").val();//入帳人員2
                         var Special2_userName = (($("#abcSpecial2_user :selected").text()).split("-"))[0];
                         var Special2_usercom = $("#abcSpecial2_user :selected").attr("comid");
                         if (Special2_user == "") {
                             Special2_userName = "";
                             Special2_usercom = "";
                         }
                         var Special3_user = $("#abcSpecial3_user").val();//入帳人員3
                         var Special3_userName = (($("#abcSpecial3_user :selected").text()).split("-"))[0];
                         var Special3_usercom = $("#abcSpecial3_user :selected").attr("comid");
                         if (Special3_user == "") {
                             Special3_userName = "";
                             Special3_usercom = "";
                         }
                         var T_accountmoney1 = $("#abcT_accountmoney1").val();//入帳金額1
                         var T_accountmoney2 = $("#abcT_accountmoney2").val();//入帳金額2
                         var T_accountmoney3 = $("#abcT_accountmoney3").val();//入帳金額3
                         var begindate_Date = datePickDateTOsqlDate($("#abcbegindate_Date").val());//入會日期
                         var enddate_Date = datePickDateTOsqlDate($("#abcenddate_Date").val());//到期日期
                         var Media = $("#abcMedia").val();//設鎖碼影音
                         var CellPhone = $("#CellPhone").val();//設定手機
                         var ATM = $("#abcATM").val();//ATM後五碼
                         var T_Ivo = $("#abcT_Ivo").val();//寄發狀況(1:正常/2:空白信封/3:發票轉交業務/4:不寄/5:捐贈)
                         var INV_ITEM = $("#abcINV_ITEM").val();//發票種類(1:二聯/2:三聯)
                         ...
                         data = "M_ID=" + M_ID_G +
                             ...
                             "&Paymoney=" + Paymoney +//會費(入帳資訊)[單筆]
                             "&Paymoney1=" + Paymoney1 +////金額1[多筆]
                             "&Paymoney2=" + Paymoney2 +////金額2[多筆]
                             "&T_PType=" + T_PType +////付款方式
                             "&T_PType1=" + T_PType1 +//付款方式1
                             "&T_PType2=" + T_PType2 +//付款方式2
                             "&T_Type=" + T_Type +//入會方式
                             "&PT_Item=" + PT_Item +////付款類型
                             "&V_ID=" + V_ID +//會場
                             "&V_Name=" + V_Name +
                             "&Special1_user=" + Special1_user +////入帳人員1
                             "&Special1_userName=" + Special1_userName +////入帳人員1
                             "&Special1_usercom=" + Special1_usercom +////入帳人員1
                             "&Special2_user=" + Special2_user +//入帳人員2
                             "&Special2_userName=" + Special2_userName +//入帳人員2
                             "&Special2_usercom=" + Special2_usercom +//入帳人員3
                             "&Special3_user=" + Special3_user +//入帳人員3
                             "&Special3_userName=" + Special3_userName +//入帳人員3
                             "&Special3_usercom=" + Special3_usercom +//入帳人員3
                             "&T_accountmoney1=" + T_accountmoney1 +//入帳金額1
                             "&T_accountmoney2=" + T_accountmoney2 +//入帳金額2
                             "&T_accountmoney3=" + T_accountmoney3 +//入帳金額3
                             "&begindate_Date=" + begindate_Date +//入會時間
                             "&enddate_Date=" + enddate_Date +//到期時間
                             "&Media=" + Media +//設鎖碼影音
                             "&CellPhone=" + CellPhone +//設定手機
                             "&Mess=" + Mess +//設訊
                             "&ATM=" + ATM +//ATM後五碼
                             "&T_Ivo=" + T_Ivo +//寄發狀況(1:正常/2:空白信封/3:發票轉交業務/4:不寄/5:捐贈)
                             "&INV_ITEM=" + INV_ITEM +//發票種類(1:二聯/2:三聯)
                             ...
                             "&ca_id=" + ca_id +////委任資料
                             //    var U_Leader = $("#abcU_Leader").val();
                             //var U_LeaderCom = $("#abcU_Com").val();
                             //var U_LeaderName = $("#abcU_Leader :selected").text();
                             "&U_Leader=" + U_Leader +////簽核主管(公司)
                             "&U_LeaderCom=" + U_LeaderCom +//簽核主管(部門)
                             "& U_LeaderName=" + U_LeaderName +//簽核主管(姓名)
                             "&Obj=" + Obj +//件別
                             "&F_Status=1&PS=" + PS +//備註
                             "&add_user=" + U_Num_M +//使用者員工編號
                             "&add_com=" + ComID_G +//使用者公司代號
                             "&add_ip=" + IP_G +//目前登入IP
         ...
         var getAppointData = function () {
             ...
             var success = function (back) {
                 ...
                 $.each(json, function (i, v) {
                     ...
                     sb.append("</a></td><td class='textAlignCenter'>");
                     sb.append(v.C_name);
                     sb.append("</td><td class='textAlignCenter'>");
                     sb.append(v.P_Name);
                     sb.append("</td><td class='textAlignCenter'>");
         ...
         var startPage2 = function () {
             ...
             $(".AnalystChangeFuc").on("change", comMdepChangeFuc);
             ...
             onClick_M("#abcgetAppointData", getAppointData);
