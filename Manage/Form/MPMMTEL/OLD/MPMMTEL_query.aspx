<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MPMMTEL_query.aspx.cs" Inherits="Manage_Form_MPMMTEL_MPMMTEL_query" %>
                        ...
                        <thead id="">
                                <tr class="active">
                                 ...
                                 <span class="inputSearch">
                                                &nbsp;<button type="button" class="btn btn-info btn-flat searchSRMVENUDataFuc qPer" id="searchSRMVENUDataFuc">查詢</button>
                                            </span>
                                              </td>
                                        <span></span>
                                        &nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button2" runat="server" Text="新增電話統計" OnClick="Button2_Click" />
                        <asp:Button ID="Button3" runat="server" Text="活動管理" />
&nbsp;<td width="30%" align="right">&nbsp;
                        ...
                        <!-- /.box-header -->
                        <div class="box-body">
                            <asp:GridView ID="Main" runat="server" AutoGenerateColumns="False" style='background-color:' Height="138px" Width="1860px"  AllowPaging="True"  PageIndex="1" OnPageIndexChanging="Main_PageIndexChanging">
                                <Columns>
                                    <asp:BoundField DataField="No" HeaderText="No" />
                                    <asp:BoundField HeaderText="日期" DataField="MT_Date"/>
                                    <asp:BoundField HeaderText="分析師" DataField="U_Name"/>
                                    <asp:BoundField HeaderText="節目種類" DataField="ddesc"/>
                                    <asp:BoundField HeaderText="節目名稱" DataField="Name&Date"/>
                                    <asp:BoundField HeaderText="可KEY" DataField="MT_OKEY"/>
                                    <asp:BoundField HeaderText="不可KEY" DataField="MT_nKEY"/>
                                    <asp:BoundField HeaderText="建檔人員" DataField="U_Name1"/>
    ...
    <script>                                      
        ...
        var afterSuccessFuc = function () {
            onChange_M("#MP", function () {
                var type = val_M("#MP");
                $Common.MITEM.getListHtmlTagOption(CommonHandlerUrl_M, "#smdM_MP", type, "option");
            });
        };
        ...
        var startThisPage = function () {
            //alert("Load分析師下拉式選單");
            //$Common.MUSER.getAnalystListHtmlTagOptionForMessageSearch(CommonHandlerUrl_M, "#MP_ITem", ComID_M, U_MDEP_M, U_POSITION_M, U_Leader_M, U_Num_M, afterSuccessFuc);
            $Common.MITEM.getListHtmlTagOption(CommonHandlerUrl_M, "#smdM_MP", type, "option");
