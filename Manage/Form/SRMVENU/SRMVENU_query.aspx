<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SRMVENU_query.aspx.cs" Inherits="Manage_Form_SRMVENU_query" %>
                                ...
                                <thead>
                                    <tr class="active">
                                        ...
                                        <th class="" colspan="6">
                                          ...
                                          分析師:&nbsp;<span><span class="inputSearch marginRight20"><select id="MP_Item" class="form-control" fieldname="分析師"><option value="">請選擇</option></select>
                                               </span></span>
                                             會場日期:
                                                <span class="inputSearch">
                                                &nbsp;<input type="text" id="MeetingDate" class="datepicker form-control today" placeholder="會場日期">
                                                   
                                            </span>
                                                 <span class="inputSearch">
                                                &nbsp;<button type="button" class="btn btn-info btn-flat noticeBoardDataFuc qPer" id="noticeBoardDataFuc">查詢</button>
                                            </span>
                                    ...
                                    <tr class="bgBlue">
                                        ...
                                        <th class="width5percent" style="text-align: center;">交易件數</th>
    ...
    <script src="<%=getRelativePath()%>js/pageList/callMessageManagement/getAllPowerSendRecord.js" type="text/javascript"></script> 
        ...
        <%--var MENU_no_G = "<%=getMENU_no()%>";--%>
            ...
            var makeHtml = function () {
                ...
                //        var data = "MP_Name=" + MP_Name + "&MeetingDate=" + MeetingDate + "&action=searchSRMVENUData";
                //        console.log("MP_Name=" + MP_Name + "&MeetingDate=" + MeetingDate + "&action=searchSRMVENUData");
            ...
            var searchSRMVENUDataFuc = function () {
                alert("searchSRMVENUDataFuc");
                var MeetingDate = val_M("#MeetingDate");//會場日期
                //alert(MeetingDate);
                var Q_Analyst = val_M("#smdM_MP") == null ? emptyValue_M : val_M("#smdM_MP");//分析師員工編號
                //alert(Q_Analyst);
                var doNext = true;
            ...
            var startThisPage = function () {
                 ...
                 * var MeetingDate = val_M("#MeetingDate");
                        ...
                        var data = "MP_Name=" + MP_Name + "&MeetingDate=" + MeetingDate + "&action=searchSRMVENUData";
                 */
                var data = "U_Num=" + U_Num_M + "&MeetingDate=" + MeetingDate +"&action=getSRMVENUData";
                var success = function (back) {
                    var json = jsonParse_M(back);
                ...
                //查詢之功能系結
                onClick_M(".searchSRMVENUDataFuc", searchSRMVENUDataFuc);
                click_M("#searchSRMVENUDataSuccess");
