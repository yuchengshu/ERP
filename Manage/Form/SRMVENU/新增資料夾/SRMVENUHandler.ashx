...
public class SRMVENUHandler : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        switch (action)
        {
            case "getSRMVENUData":
                ...
                context.Response.Write(getVenueDataList(U_Num,keyWord));
                break;
            case "deleteSRMVENMUData":
                MS_ID = context.Request["MS_ID"];
                context.Response.Write(deleteMailData(MS_ID));
                break;
            case "addSRMVENMUData":
    ...
    /// </summary>
    /// <returns></returns>
    public string getSRMVENUDataList()
    {
        string methodName = System.Reflection.MethodBase.GetCurrentMethod().Name;
        ...
        List<SRMVENUEntity> vdeList = srmvenuService.Instance.getSRMVENUData();//有問題
    ...
    public string getVenueDataList(string U_Num,string keyWord)
    {
        string methodName = System.Reflection.MethodBase.GetCurrentMethod().Name;
        log.startWrite("'U_Num;':"+U_Num+"'keyWord;':"+keyWord, className, methodName);
        //取得所有會場編號
    ...
    public string getMUSERData(string MS_ID)
    {
        ...
        log.startWrite("'MS_ID':" + MS_ID, className, methodName);
        //string keyword = "";
        List<muserEntity> muser = muserService.Instance.getMUSERData(MS_ID,"","","");//<==========
