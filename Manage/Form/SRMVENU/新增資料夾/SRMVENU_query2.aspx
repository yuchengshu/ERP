<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SRMVENU_query.aspx.cs" Inherits="Manage_Form_SRMVENU_SRMVENU_query" %>
                        ...
                        <thead id="">
                                <tr class="active">
                                    <th class="" colspan="6">
                                        ...
                                        <td>分析師:<asp:DropDownList ID="MP_ITem_DDL" runat="server" OnDataBound="MP_ITem_DDL_DataBound" OnSelectedIndexChanged="MP_ITem_DDL_SelectedIndexChanged" AutoPostBack="true" >
                        </asp:DropDownList>
                                            &nbsp;
