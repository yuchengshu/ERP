<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MMBER_query.aspx.cs" Inherits="Manage_TKMMBER_MMBER_query" %>
    ...
    <script>                                      
        ...
        var makeHtml = function () {
            ...
            if (CustomerDataJson_G.length != 0) {
                ...
                $.each(CustomerDataJson_G, function (i, v) {
                    ...
                    if (n >= startCount && n <= endCount) {
                        ...
                        if (isMember) {
                            ...
                            sb.append("<th class='text-center'><a href='#' class='delMCMCashData delPer' MID='");
                            sb.append(v.M_ID);
                            sb.append("'>刪</a></th>");
                        }
                ...
                onClick_M(".delMCMCashData", function () {
