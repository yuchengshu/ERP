...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script>
        ...
        * */
        ...
        //var InvoiceCreateURL1 = "https://www.hwa-guan.com.tw/Financial/Add";//呼叫加法(可用)
        ...
        var InvoiceCreate = function () {
            ...
            //    //    alert(t_id[2]);
                //var jsonData = "action=GetItemByT_ID" + "&T_ID=" + T_ID;//由T_ID取得其他參數(GetItemByT_ID)//20221101
                var data = "action=GetItemByT_ID" + "&T_ID=" + T_ID;//由T_ID取得其他參數(GetItemByT_ID)(T_ID);
            ...
            //    //////////////////////////////////////////
                ...
                success = function (back) {
                    ...
                    ajax_M(InvoiceCreateURL, data, data_InvoiceCreate_Success, data_InvoiceCreate_error);//利用產生的詳細資料呼叫開發票API
