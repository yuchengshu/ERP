<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AllPayorder_query.aspx.cs" Inherits="Manage_Form_MSFTF_query" %>
                ...
                <div class="col-md-12">
                    <div class="box box-danger">
                        <div class="box-header">
                            ...
                            <h1 class="box-title"><b>ERP &gt;輕鬆學院訂單管理</b> </h1>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="1">
                                <thead id="">                                          
                                         <tr class ="bgBlue">
                                            ...
                                            <th class="" style="width: 10%;text-align:center;">訂單</th>
                                            ...
                                            <th class="" style="width: 5%;text-align:center;">聯絡</th>
                                            <th class="" style="width: 15%;text-align:center;">訂單內容</th>
                                            <th class="" style="width: 15%;text-align:center;">訂單金額</th>
                                             <th class="" style="width: 5%;text-align:center;">轉入</th>
