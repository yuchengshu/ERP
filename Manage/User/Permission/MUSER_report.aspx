<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MUSER_report.aspx.cs" Inherits="Manage_User_MUSER_report" %>
...
　                        <div id="pageBar" style="margin:0 auto;"></div>
    ...
    <script>
        ...
        //取得首頁權限資料
        var getHomePagePerquery = function () {
            var data = "action=getHomePagePerqueryData" + "&keyWord=" + val_M("#keyWord") + "&PayStatus=" + val_M("#PayStatus") + "&U_MDEP=" + U_MDEP_M + "&ComID=" + ComID_M + "&U_Num=" + U_Num_M;
        ...
        var startThisPage = function () {
            ...
            var data = "U_Num=" + U_Num_M + "&action=getHomePagePerquery";
            var success = function (back) {
                var json = jsonParse_M(back);
