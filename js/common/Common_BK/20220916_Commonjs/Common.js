...
(function (m) {
    ...
    m.MITEM = {
        ...
        // $Common.MITEM.getListHtmlTagOption(CommonHandlerUrl_M, "#SelectTownShip", "TownShip", "option", county);
        /**
         * 銀行關鍵字搜尋
          //getListHtmlTagOption: function (ul, idOrClassName, listType, htmlTagType, BankKeyWord, afterSuccessFuc) {
         */
        ...
        //使用者維護作業(//取得[縣/市])-修改執行這段
        //$Common.MITEM.getListHtmlTagOption(CommonHandlerUrl_M, "#SelectCom", "Com", "option", "4");
    ...
    //},
        //銀行關鍵字搜尋
        //使用者維護作業(//取得[縣/市])-修改
        //設定預設[部門](SelectedValue)
        //設定預設[所屬公司](SelectedValue)
        //設定預設[等級](SelectedValue)
        //設定預設[職稱](SelectedValue)
        //$Common.MITEM.getListHtmlTagOption(CommonHandlerUrl_M, "#SelectDept_Title1", "Dept", "option");對應這個
