...
(function (m) {
    ...
    m.Table = {
        ...
        makeTbody: function (tbId, dataArr, perCountOnePage, pageBarId, getRecordFuc) {
            ...
            if (m.Check.isEmptyStr(tbId)) {
                ...
                getRecordFuc = m.Table.getRecordFuc;
            } else {
                ...
                m.Table.getRecordFuc = getRecordFuc;
            }
            $(tbId).empty();
            ...
            for (var i = start ; i < end ; i++) {
                    ...
                    sb.append("</td>");
                    sb.append("<td class='text-center'>");
                    if (!m.Check.isEmptyStr(dataArr[i].M_Num)) {
                        sb.append("會");
                    }
                    sb.append("</td>");
                    sb.append("<td class='text-center'><a href='javascript:void(0)' class='getRecordFuc' M_ID='");
                    ...
                    sb.append("</td>");
                    sb.append("<td class='text-center'>");
                    if (!m.Check.isEmptyStr(dataArr[i].OTel)) {
                        sb.append(dataArr[i].OTel_Zone);
                        sb.append("-");
                        sb.append(dataArr[i].OTel);
                        if (!m.Check.isEmptyStr(dataArr[i].OTel_Sub)) {
                            sb.append("#");
                            sb.append(dataArr[i].OTel_Sub);
                        }
                        sb.append("<br/>");
                    }
                    if (!m.Check.isEmptyStr(dataArr[i].OTel1)) {
                        sb.append(dataArr[i].OTel_Zone1);
                        sb.append("-");
                        sb.append(dataArr[i].OTel1);
                        if (!m.Check.isEmptyStr(dataArr[i].OTel_Sub1)) {
                            sb.append("#");
                    ...
                    sb.append("</td>");
                    sb.append("<td class='text-center'>");
                    if (!m.Check.isEmptyStr(dataArr[i].HTel)) {
                    ...
                    if (!m.Check.isEmptyStr(dataArr[i].HTel1)) {
                    ...
                    sb.append("</td>");
                    sb.append("<td class='text-center'>");
                    sb.append(dataArr[i].Change_date);
                    sb.append("</td>");
                    sb.append("</tr>");
            }
            $(tbId).append(sb.toString());
            $(".getRecordFuc").on("click", getRecordFuc);
