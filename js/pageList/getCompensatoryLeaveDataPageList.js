...
$getCompensatoryLeaveDataPageList = {
    version: "1.0.0"
};
    ...
    m.Table = {
        ...
        makeTbody: function (tbId, dataArr, perCountOnePage, pageBarId, deleteDataFuc) {
            ...
            for (var i = start ; i < end ; i++) {
                ...
                sb.append(dataArr[i].DE_ID);
                sb.append("</th>");
                sb.append("<th class='text-center'>");
                sb.append(dataArr[i].DE_Name);
                sb.append("</th>");
                sb.append("<th class='text-center'>");
                sb.append(dataArr[i].DE_SDate);
                sb.append("</th>");
                sb.append("<th class='text-center'>");
                sb.append(dataArr[i].DE_EDate);
                sb.append("</th>");
                sb.append("<th class='text-center'>");
                sb.append(dataArr[i].DE_Ps);
                sb.append("</th>");
                sb.append("</tr>");
            }
            $(tbId).append(sb.toString());
            //$(".deleteFuc").on("click", deleteLeaveDataFuc);
