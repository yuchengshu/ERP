...
(function (m) {
    ...
    m.Table = {
        ...
        //顯示自訂時間資料
        makeCustomUserSETimeDataTbody: function (tbId, dataArr, perCountOnePage, pageBarId, deleteDataFuc, getDetailFuc) {
            ...
            for (var i = start; i < end; i++) {
                ...
                sb.append("</th>");
                sb.append("<th class='text-center'>");
                sb.append(dataArr[i].ditcode);//員工編號
                /*sb.append("'>");*/
                sb.append("</th>");
                sb.append("<th class='text-center'>");
                sb.append(dataArr[i].U_Name);//員工姓名
                sb.append("</th>");
               /* sb.append("<th class='text-center'><a href='#' class='getDetail qPer' MS_ID='");*/
                sb.append("<th class='text-center'>");
                sb.append(dataArr[i].StartTime);
                sb.append("</th>");
                /* sb.append("<th class='text-center'><a href='#' class='getDetail qPer' MS_ID='");*/
                sb.append("<th class='text-center'>");
                sb.append(dataArr[i].EndTime);
                sb.append("</th>");
                sb.append("<th class='text-center'>");
                sb.append(dataArr[i].MS_Text);
                sb.append("</th></tr>");
