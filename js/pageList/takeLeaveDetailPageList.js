    ...
    m.Table = {
        ...
        makeTbody: function (tbId, dataArr, perCountOnePage, pageBarId, deleteDataFuc,getDetailFuc) {
            ...
            for (var i = start ; i < end ; i++) {
                ...
                sb.append(i + 1);
                sb.append("</th>");
                sb.append("<th class='text-center'><a href='#' class='getLeaveDetail qPer' exId='");
                sb.append(dataArr[i].EX_id);
                sb.append("'>");
                sb.append(dataArr[i].EX_id);
                sb.append("</a></th>");
                sb.append("<th class='text-center'>");
                sb.append(dataArr[i].EX_TypeName);
                sb.append("</th>");
                sb.append("<th class='text-center'>");
                sb.append(dataArr[i].EX_Name);
                sb.append("</th>");
                sb.append("<th class='text-center'>");
                sb.append(dataArr[i].EX_SDate);
                sb.append("</th>");
                sb.append("<th class='text-center'>");
                sb.append(dataArr[i].EX_EDate);
                sb.append("</th>");
                sb.append("<th class='text-center'>");
                sb.append(dataArr[i].EX_Day);
                sb.append(" 天 ");
                sb.append(dataArr[i].EX_Hour);
                sb.append(" 小時");
                sb.append("</th>");
                sb.append("<th class='text-center'>");
                sb.append(dataArr[i].EX_StatusName);
                sb.append("</th>");
                sb.append("<th class='text-center'>");
                sb.append(dataArr[i].EX_Govern_time);
                sb.append("</th>");
                sb.append("<th class='text-center'><a href='#' deleteId='");
                sb.append(dataArr[i].EX_id);
                sb.append("' class='deleteLeaveData delPer'>刪</a></th>");
            }
            $(tbId).append(sb.toString());
            $(".deleteLeaveData").on("click", deleteDataFuc);
            $(".getLeaveDetail").on("click", getDetailFuc);
