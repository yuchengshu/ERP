...
(function (m) {
    ...
    m.Table = {
        ...
        makeTbody: function (tbId, dataArr, perCountOnePage, pageBarId) {
            ...
            for (var i = start ; i < end ; i++) {
                    ...
                    sb.append("</td>");
                    sb.append("<td class='text-center'>");
                    sb.append(dataArr[i].M_TEL);
                    sb.append("</td>");
                    sb.append("<td class='text-center'>");
                    sb.append(dataArr[i].M_MPname);
                    sb.append("-");
                    sb.append(dataArr[i].M_MITemName);
                    sb.append("</td>");
                    sb.append("<td class='text-center'>");
                    var M_Text = dataArr[i].M_Text;
                    var M_TextLength = M_Text.length;
                    sb.append(M_TextLength);
                    sb.append("字");
                    sb.append("/");
                    var hasCineseTF = hasChineseCharTF_M(M_Text);
                    var messageCount = countMessageChar_M(hasCineseTF, M_TextLength);
                    sb.append(messageCount);
                    sb.append("通");
                    sb.append("</td>");
                    sb.append("<td class=''>");
                    sb.append(dataArr[i].M_Text);
                    sb.append("</td>");
                    sb.append("<td class='text-center'>");
                    sb.append(dataArr[i].M_TStatusName);
                    sb.append("</td>");
                    sb.append("<td class='text-center' id='GMSN");
                    sb.append(num);
                    sb.append("'>");
                //sb.append(dataArr[i].getMessageStatusName);
                    sb.append(getMessageStatus(dataArr[i].M_SEQ, "#GMSN" + num));
                    sb.append("</td>");
                    sb.append("<td class='text-center'>");
