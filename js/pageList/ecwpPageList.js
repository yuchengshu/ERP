    ...
    m.Table = {
        ...
        makeTbody: function (tbId, dataArr, perCountOnePage, pageBarId, deleteDataFuc,getDetailFuc) {
            ...
            for (var i = start ; i < end ; i++) {
                ...
                sb.append(dataArr[i].Pay_Serial);
                sb.append("</th>");

                sb.append("<th class='text-center'>");
                sb.append(dataArr[i].C_Tel);
                sb.append("</th>");
                sb.append("<th class='text-center'>");
                ...
                sb.append("</th>");
                sb.append("<th class='text-center'><a href='javascript:void(0)' class='getDetail' M_id='");
                sb.append(dataArr[i].M_id);
                sb.append("' >");
                sb.append(dataArr[i].C_name);
                sb.append("</a></th>");
                sb.append("<th class='text-center'>");
                ...
                sb.append("</th>");
                sb.append("<th class='text-center'>");
                sb.append(dataArr[i].Done_TagName);
                sb.append("</th>");
                sb.append("<th class='text-center'>");
                sb.append(dataArr[i].o_id);
                sb.append("<br />");
                sb.append(dataArr[i].Payway);
                if (!isEmptyStr(dataArr[i].Card4NO)) {
                    sb.append("<br />");
                    sb.append("卡末4碼：");
                    sb.append(dataArr[i].Card4NO);
                }
                sb.append("</th>");
                sb.append("<th class='text-center'><a href='javascript:void(0)' class='deleteData delPer' ca_id='");
                sb.append(dataArr[i].ca_id);
                sb.append("'>刪</a></th>");
            }
