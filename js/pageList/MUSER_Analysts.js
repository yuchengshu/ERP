    ...
    m.Table = {
        ...
        makeTbody: function (tbId, dataArr, perCountOnePage, pageBarId, deleteDataFuc, getDetailFuc) {
            ...
            for (var i = start; i < end; i++) {
                ...
                sb.append("</th>")
                sb.append("<th class='text-center'><input type='checkbox' name='per_open_'") +
        ...
        makeTbody: function (tbId, dataArr, perCountOnePage, pageBarId, deleteDataFuc, getDetailFuc, editDataFuc) {
