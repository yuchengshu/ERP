    ...
    m.Table = {
        ...
        makeTbody: function (tbId, dataArr, perCountOnePage, pageBarId, deleteDataFuc,getDetailFuc) {
            ...
            for (var i = start ; i < end ; i++) {
                ...
                sb.append(i + 1);
                sb.append("</th>");
                if (dataArr[i].adver_item == "1") {
                    sb.append("<th class='text-center'>公告:<a href='#' class='getDetail qPer' adver_id='");
                } else {
                    sb.append("<th class='text-center'><a href='#' class='getDetail qPer' adver_id='");
                }
                
                sb.append(dataArr[i].adver_id);
                sb.append("' adver_create_date='");
                sb.append(dataArr[i].adver_create_date);
                sb.append("' adver_subject='");
                sb.append(dataArr[i].adver_subject);
                sb.append("' adver_employ_id='");
                sb.append(dataArr[i].adver_employ_id);
                sb.append("' adver_depart_id='");
                sb.append("發布對象"+dataArr[i].adver_depart_id);
                sb.append("' adver_Com='");
                sb.append("發布單位"+dataArr[i].adver_Com);
                sb.append("' adver_content='");
                sb.append(dataArr[i].adver_content);
                sb.append("' adver_employ_Name='");
                sb.append(dataArr[i].adver_employ_Name);
                sb.append("' adver_employ_ComIDname='");
                sb.append(dataArr[i].adver_employ_ComIDname);
                sb.append("' adver_employ_U_MDEPname='");
                sb.append(dataArr[i].adver_employ_U_MDEPname);
                ...
                sb.append("</th>");
                sb.append("<th class='text-center'>");
                sb.append(dataArr[i].adver_depName);
                sb.append("</th>");
                sb.append("<th class='text-center'>");
                sb.append(dataArr[i].adver_depart_Name);
                sb.append("</th>");
                sb.append("<th class='text-center'>");
                sb.append(dataArr[i].adver_employ_Name);
                sb.append("</th>");
               
                sb.append("<th class='text-center'><a href='#' class='qPer' itemId='");

                sb.append("' class='deleteData delPer'>-</a></th>");
                sb("</tr>")
            }
