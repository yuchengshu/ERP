...
(function (m) {
    ...
    m.Table = {
        ...
        makeTbody: function (tbId, dataArr, perCountOnePage, pageBarId, getTagHistoryFuc) {
            ...
            if (m.Check.isEmptyStr(tbId)) {
                ...
                getTagHistoryFuc = m.Table.getTagHistoryFuc;
                ...
                m.Table.getTagHistoryFuc = getTagHistoryFuc;
            ...
            for (var i = start ; i < end ; i++) {
                    ...
                    sb.append("<td class='textAlignCenter'>");
                        sb.append(i + 1);
                        sb.append("</td>");
                        sb.append("<td class='textAlignCenter'><img style='width:25px;height:25px;' src='../../../img/");
                        sb.append(dataArr[i].Light_Status);
                        sb.append(".png");

                        
                        sb.append("'/>");
                        sb.append("</td>");
                        sb.append("<td class='textAlignCenter'><a target='_blank' href='/wealthManage/customerManage/MMBER/customerDetail.aspx?M_ID=");
                        ...
                        sb.append("</td>");
                        sb.append("<td class='textAlignCenter'>");
                        if (!m.Check.isEmptyStr(dataArr[i].MTel1)) {
                            sb.append(dataArr[i].MTel1);
                            sb.append("<br/>");
                        }
                        if (!m.Check.isEmptyStr(dataArr[i].MTel2)) {
                            sb.append(dataArr[i].MTel2);
                            sb.append("<br/>");
                        }
                        if (!m.Check.isEmptyStr(dataArr[i].MTel3)) {
                            sb.append(dataArr[i].MTel3);
                            sb.append("<br/>");
                        }
                        sb.append("</td>");
                        sb.append("<td class='textAlignCenter'>");
                        sb.append(dataArr[i].Assign_Name);
                        sb.append("</td>");
                        sb.append("<td class='textAlignCenter'>");
                        sb.append(dataArr[i].Assign_Date);
                        sb.append("</td>");
                        sb.append("<td class='textAlignCenter'>");
                        if (!m.Check.isEmptyStr(dataArr[i].LongTag_Date)) {
                            sb.append(dataArr[i].MC_Name);
                            sb.append("-");
                            sb.append(dataArr[i].LongTag_Date);
                        }
                        sb.append("</td>");
                        sb.append("<td class='textAlignCenter'>");
                        if (m.Check.isEmptyStr(dataArr[i].DM_MarkTime) && m.Check.isEmptyStr(dataArr[i].LongTag_Date)) {
                            sb.append("未短註");
                        } else {
                            if (!m.Check.isEmptyStr(dataArr[i].LongTag_Date)) {
                                sb.append("未短註");
                            } else {
                                sb.append(dataArr[i].DM_MC_Name);
                                sb.append("-");
                                sb.append(dataArr[i].DM_MarkTime);
                                sb.append("<a href='javascript:void(0)' class='getTagHistory' Mid='");
                                sb.append(dataArr[i].M_ID);
                                sb.append("'>(註記歷史)</a>");
            ...
            $(".getTagHistory").on("click", getTagHistoryFuc);
