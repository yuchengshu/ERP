...
$webConsumptionOrderManagementPageList = {
    version: "1.0.0"
};
    ...
    m.Table = {
        ...
        makeTbody: function (tbId, dataArr, perCountOnePage, pageBarId,  changeoverFuc, editDataFuc, deleteDataFuc) {
            ...
            for (var i = start ; i < end ; i++) {
                ...
                sb.append("</th>");
                sb.append("<th class='text-center'>");
                sb.append(dataArr[i].P_idName);
                sb.append("</th>");
                sb.append("<th class='text-center'><a target='_blank' href='");
               // sb.append(dataArr[i].MU_id);
                sb.append("'>");
                ...
                sb.append("<b>【");
                sb.append(dataArr[i].DPRD_Name);
                sb.append("】</b>");
                sb.append("<br/><span class='fontSizeSpan'>");
                sb.append(dataArr[i].Transaction_Time);
                sb.append("<br/>");
                sb.append(dataArr[i].EMail);
                sb.append("<br/>");
                sb.append(dataArr[i].Address);
                sb.append("<br/>");
                sb.append("<span class='fontWeightBold'>發票號碼:</span>");
                sb.append(dataArr[i].InvoiceNumber);
                sb.append("<br/>");
                sb.append("<span class='fontWeightBold'>發票載具:</span>");
                ...
                if(dataArr[i].PayStatus=="0"){
                    ...
                    sb.append(dataArr[i].O_Id);
                    sb.append("' MPRD_ID='");
                    sb.append(dataArr[i].MPRD_ID);
                    sb.append("' DPRD_ID='");
                    sb.append(dataArr[i].DPRD_ID);
                    sb.append("' Name='");
                    sb.append(dataArr[i].Name);
                    sb.append("' Tel='");
                    sb.append(dataArr[i].Tel);
