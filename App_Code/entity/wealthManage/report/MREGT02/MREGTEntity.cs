...
public class MREGTEntity
{
    ...
    public int E10 { get; set; } //漏刷
    public int E11 { get; set; } //早退
    public int E12 { get; set; } //曠職
    public int E13 { get; set; } //出勤調整
    public int E14 { get; set; } //颱風假
    public int E15 { get; set; } //榮譽假
