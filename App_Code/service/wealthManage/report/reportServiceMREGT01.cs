...
/// reportService 的摘要描述
/// </summary>
public class reportServiceMREGT01
{
    //引用時不用再NEW
    private static reportServiceMREGT01 _instance = new reportServiceMREGT01();
    public static reportServiceMREGT01 Instance
    {
        get
        {
            return _instance;
    ...
    //public List<MREGT02Entity> getMREGE02DataList(string StartDate, string EndDate, string MP, string Select_Com, string Select_Dept)
    //出缺勤異常表內容
    public List<MREGT01Entity> getMREGT01DataList(string StartDate, string EndDate)
    {
        List<muserEntity> MuserList=new List<muserEntity>();
        MuserList = MUSERhgDao.Instance.getALLEmplist("");//<==========
        ...
        MREGT01Entity mREGT01Entity = new MREGT01Entity();
        List<MREGT01Entity> MREGE02DataList = new List<MREGT01Entity>();//考勤報表畫面欄位資料來源
        mREGT01Entity.Com = COMID_Name;
        mREGT01Entity.Dept = DEPAR_Name;
        mREGT01Entity.StartDate = StartDate;
        mREGT01Entity.EndDate= EndDate;
        //if (LeaveDate == "")
        //{
