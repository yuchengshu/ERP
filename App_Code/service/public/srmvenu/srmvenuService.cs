...
/// </summary>
public class srmvenuService
{
    //引用時不用再NEW
    private static srmvenuService _instance = new srmvenuService();
    public static srmvenuService Instance
    {
        get
        {
            return _instance;
    ...
    //getSRMVENUData
    public List<SRMVENUEntity> searchSRMVENUData(string MP_CName, string MeetingDate)
    { //}//)//0428加入查詢條件!!!
    ...
    //getSRMVENUData
    public List<SRMVENUEntity> getSRMVENUData()
    { //}//)//0428加入查詢條件!!!
        ...
        string dep = string.Empty;
        //2022/04/22這邊開始寫!!!!!!!!!!
        List<SRMVENUEntity> SRMVENUEntityList = MVENUhgDao.Instance.getSRMVENUList();// MUSERhgDao.Instance.getMClist(true);
        //List<noticeBoardEntity> nbeList = MBULThgDao.Instance.getNoticeBoard(U_MDEP, U_POSITION, common.empty, fromClassName, adver_depart_id, keyWord);//<======
        //List<ditcodedescEntity> comidList = MITEMhgDao.Instance.getditcodedescEntityList("COMID");//<============================================================
        //List<ditcodedescEntity> ddeList = MITEMhgDao.Instance.getditcodedescEntityList("DEPAR");//<============================================================
        //List<indexBDdataEntity> bdList = MUSERhgDao.Instance.getEmpBDlist();//<==================================================================================
