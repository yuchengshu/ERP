...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <div class="box-body">
                            <table class="table table-hover" id="businessConnectionTab">
                                <thead id="businessConnectionThead">
                                    <tr class="active">
                                        <th class="auto-style2" colspan="4">種類
                                            <select class="form-control getMCOTFListFuc" id="CF_ITem" title="Kind">
                                    ...
                                    <tr class="bgBlue">
                                        ...
                                        <th class="" style="width: 16%; text-align: center;">聯絡單種類</th>
                                        <th class="" style="width: 11%; text-align: center;">分析師</th>
                                        <th class="" style="width: 17%; text-align: center;">會員姓名</th>
                                        <th class="" style="width: 12%; text-align: center;">提案人</th>
                                        <th class="" style="width: 12%; text-align: center;">提案日期</th>
                                        <th class="" style="width: 8%; text-align: center;">狀態</th>
    ...
    <script>
        ...
        //刪除業務聯絡單
        var deleteMPMCOTFDataFuc = function (f_id) {
            //alert("按下刪除!!!");
        ...
        var startThisPage = function () {
            ...
            //alert("取得業務聯絡單種類列表!");
            $Common.MITEM.getCFItemTagOption(CommonHandlerUrl_M, ".getMCOTFListFuc", "CF_ITem", "option");//聯絡單種類下拉式選單.getMCOTFListFuc
            //取得業聯單列表
            //alert('取得業聯單列表!!!');
