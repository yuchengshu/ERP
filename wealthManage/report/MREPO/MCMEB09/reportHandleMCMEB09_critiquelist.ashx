<%@ WebHandler Language="C#" Class="reportHandleMCMEB09_critiquelist" %>
...
public class reportHandleMCMEB09_critiquelist : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        switch (action)
        {
            ...
            //<a href="/wealthManage/report/MREPO/MCMEB09/MCMEB09_critiquelist.aspx?P_ID=D0903021&amp;MR_DateY=2022&amp;MR_DateM_G=1">6933</a>
            //[20221115]http://localhost:13333/wealthManage/report/MREPO/MCMEB09/MCMEB09_critiquelist.aspx?C_ID=D0903021&MR_DateY=2022&MR_DateM=1
                case "getMCMEB09_critiquelistData"://
                C_ID = context.Request["C_ID"];//分析師編號
                MR_DateY = context.Request["MR_DateY"];
                MR_DateM = context.Request["MR_DateM"];
                ///20221110進度(取回對應的資料,並顯示在畫面上)
                context.Response.Write(getMCMEB09_critiquelistData(C_ID, MR_DateY, MR_DateM));
                break;
    ...
    //20221110進度
    public string getMCMEB09_critiquelistData(string M_ID, string MR_DateY, string MR_DateM)
    {
        string methodName = System.Reflection.MethodBase.GetCurrentMethod().Name;
        List<ClickDetailEntity> getMCMEB09_critiquelist_Click = new List<ClickDetailEntity>();
        ...
        if (M_ID != "")
        {
            ...
            getMCMEB09_critiquelist_Click = reportServiceMCMEB09.Instance.getClickDetail("critique", T_ID, MR_DateY, MR_DateM);//<==========
            log.endWrite("'getMCMEB09_critiquelist_Click' : " + getMCMEB09_critiquelist_Click.ToString(), className, methodName);
            return Newtonsoft.Json.JsonConvert.SerializeObject(getMCMEB09_critiquelist_Click);
        }
        log.endWrite("'critiquelist' : " + getMCMEB09_critiquelist_Click.ToString(), className, methodName);
        return Newtonsoft.Json.JsonConvert.SerializeObject(getMCMEB09_critiquelist_Click);
    }
