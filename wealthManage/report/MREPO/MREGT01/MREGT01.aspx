<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MREGT01.aspx.cs" Inherits="wealthManage_report_MREPO_MREGT02_MREGT02_DetailList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-danger">
                        ...
                        <!-- /.box-header -->
                        <div id="MREGT01Data_Inquire"  class="form-control">

                        </div>
                        <div id="MREGT01Data_List" class="form-control">
                            日期：
    ...
    <script>
        ...
        var reportHandlerMREGE01_List_Url_G = "reportHandlerMREGT01.ashx";
        ...
        var getMREGT01_List = function () {
            ...
            var data = "U_Num=" + U_Num + "&ComID=" + ComID + "&U_MDEP=" + U_MDEP + "&MR_SDate=" + MR_SDate + "&MR_EDate=" + MR_EDate + "&action=getMREGT01DataList";
            Log_M(" data=" + data);
