<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MREGT02.aspx.cs" Inherits="wealthManage_report_MREPO_MCMEB09_MCMEB09" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div class="col-md-12">
                    <div class="box box-danger">
                        <div class="box-header">
                            ...
                            <h1 class="box-title"><b>ERP &gt;  報表區 &gt;考勤報表</b> </h1>
                            ...
                            <table class="table table-hover marginTop10">
                                <thead id="">
                                    <tr class="bgGray">
                                        ...
                                        <th class="auto-style1">公司</th>
                                        <th class="auto-style1">部門</th>
                                        <th class="auto-style1">到職日</th>
                                        <th class="auto-style1">離職日</th>
                                        <th class="auto-style1">年假</th>
                                        <th class="auto-style1">補休</th>
                                        <th class="auto-style1">公假</th>
                                        <th class="auto-style1">婚假</th>
                                        <th class="auto-style1">喪假</th>
                                        <th class="auto-style1">產假</th>
                                        <th class="auto-style1">事假</th>
                                        <th class="auto-style1">病假</th>
                                        <th class="auto-style1">颱風假</th>
                                        <th class="auto-style1">榮譽假</th>
                                        <th class="auto-style1">曠職</th>
                                        <th class="auto-style1">家庭照護</th>
                                        <th class="auto-style1">遲到</th>
                                        <th class="auto-style1">漏刷</th>
                                        <th class="auto-style1">早退</th>
                                        <th class="auto-style1">詳細</th>
                                    </tr>
    ...
    <script>
        ...
        var getMREGT02DataList = function () {
            ...
            //選到[請選擇](全選)
            //if (MP.length = 0) {
            var x = document.getElementById('#Select_Employ');
            var txt = "";
            var val = "";
            //for (var i = 0; i < x.length; i++) {
            //    txt += x[i].text + ",";
            //    val += x[i].value + ",";//所有的員工編號
            //}
            ...
            if (!x) {
                ...
                alert(Select_Com);
                alert(Select_Dept);
                alert('選到公司代號:' + Select_Com + ' 部門代號' + Select_Dept + '所有員工的出缺勤紀錄!');
                var data_All = "StartDate=" + StartDate + "&EndDate=" + EndDate + "&Select_Com=" + Select_Com + "&Select_Dept=" + Select_Dept + "&action=getMREGT02DataList";//取得同部門所有員工資料
                var success = function (back) {
                    Log_M(" back=" + back);
                    var json = jsonParse_M(back);
                    var sb = new StringBuilder_M();
            ...
            var data = "StartDate=" + StartDate + "&EndDate=" + EndDate + "&Selected_UNUM=" + Select_Employ + "&Select_Com=" + Select_Com + "&Select_Dept=" + Select_Dept + "&action=getMREGT02DataList";
            var success = function (back) {
                Log_M(" back=" + back);
                var json = jsonParse_M(back);
                var sb = new StringBuilder_M();
