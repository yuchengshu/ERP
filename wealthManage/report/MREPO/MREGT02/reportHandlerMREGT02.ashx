<%@ WebHandler Language="C#" Class="reportHandlerMREGT02" %>
...
public class reportHandlerMREGT02 : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        string action = context.Request["action"];//(getMREGT02DataList)
        ...
        switch (action)
        {       //getMREGE02DataList_Detail
            //getMREGE02DataList_Detail
            //case "getMREGT02DetailDataList":
            //    U_Num = context.Request["U_Num"];
            //    U_MDEP = context.Request["U_MDEP"];
            //    StartDate = context.Request["MR_SDate"];
            //    EndDate = context.Request["MR_EDate"];
            //    ComID = context.Request["ComID"];
            //    context.Response.Write(getMREGT02DetailDataList(StartDate, EndDate, U_Num,ComID,U_MDEP));
            //    break;
            //getMREGT02DataList
    ...
    //20221213進度!!!!!!!!!
    //20221208進度getMREGE02DataList_Detail
    // context.Response.Write(getMREGE02DataList_Detail(StartDate, EndDate, U_Num,ComID,U_MDEP, StartDate, StartDate));
    //public string getMREGT02DetailDataList(string StartDate, string EndDate, string U_Num, string ComID, string U_MDEP)
    //{
    ...
    //    //20221213這裡要修改!!!
    //    MREGT02DetailList = reportServiceMREGT02.Instance.getMREGT02DetailDataList(U_Num, StartDate, EndDate, ComID, U_MDEP);//<==========

    //    //}
    //    log.endWrite("'mcseList' : " + MREGT02DetailList.ToString(), className, methodName);
