<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MCMEB09_medialist.aspx.cs" Inherits="wealthManage_report_MREPO_MCMEB09_MCMEB09_medialist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div class="col-md-12">
                    <div class="box box-danger">
                        <div class="box-header">
                            ...
                            <h1 class="box-title"><b>廣播-總點閱</b> </h1>
    ...
    <script>
        ...
        var MCMEB09_medialistHandlerUrl_G = "/wealthManage/report/MREPO/MCMEB09/reportHandleMCMEB09_medialist.ashx";
        var makeHtml = function () {
            ...
            //MCMEB09_youtubelistDataJson_G
            if (MCMEB09_medialistDataJson_G.length != 0) {
                ...
                $.each(MCMEB09_medialistDataJson_G, function (i, v) {
                    n += 1;
                    if (n >= startCount && n <= endCount) {
                        ...
                        sb.append("<a href='https://www.hwa-guan.com.tw/Wealth/ViewPoint/RadioDetail?M_id=");
                        sb.append(v.V_id);
                        sb.append("' target=");
                        sb.append(v.V_id);
                        sb.append(">")
        ...
        var startThisPage = function () {
            var data = "M_ID=" + M_ID + "&MR_DateY=" + MR_DateY + "&MR_DateM=" + MR_DateM + "&action=getMCMEB09_mediallistData";
            var searchCustomerDataSuccess = function (back) {
                MCMEB09_medialistDataJson_G = jsonParse_M(back);
            ...
            ajax_M(MCMEB09_medialistHandlerUrl_G, data, searchCustomerDataSuccess, error);//<===
        }
        //
        var MCMEB09_medialistData = function () {
            ...
            var success = function (back) {
                ...
                MCMEB09_medialistData = jsonParse_M(back);
                //$muser_MenuSetupPageList.Table.makeTbody("#MUSER_MenuSetupData", json, 10, "#pageBar", deleteData, getMid);
                makeHtml();//依所得資料產生畫面
            };
            var error = function (e) { Log_M("MCMEB09_medialistData error=" + e); unBlockUI_M(); };
            ajax_M(MCMEB09_medialistHandlerUrl_G, data, success, error);
        };
        //20221109
        $(function () {
            //alert('Start!!');
