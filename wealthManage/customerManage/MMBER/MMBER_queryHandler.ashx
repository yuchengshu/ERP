...
public class customerManageHandler : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        switch (action)
        {
            ...
            case "addEditCustomerData"://新增客戶資料
            ...
            case "getAnalystForCashFlow":
                ...
                context.Response.Write(getAnalystForCashFlow(ComID));
                break;
            case "getAnalystItem":
            ...
            case "getMCMSFTFList":
                T_ID = context.Request["T_ID"];
                context.Response.Write(getMCMSFTFList(T_ID));
                break;
    ...
    public string getMCMSFTFList(string T_id)
    {
        string methodName = System.Reflection.MethodBase.GetCurrentMethod().Name;
        log.startWrite("'T_id' : "+T_id, className, methodName);
    ...
    //public string getMSFTFList(string analyst)
    //{
    //    string methodName = System.Reflection.MethodBase.GetCurrentMethod().Name;
    //    log.startWrite("'analyst' : "+analyst, className, methodName);

    //    List<msftfEntity> ibddeList = MSFTFhgDao.Instance.getMSftfList(analyst);
