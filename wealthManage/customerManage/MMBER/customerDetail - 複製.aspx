...
<body style="font-family: Microsoft JhengHei;">
    ...
    <div id="addBusinessConnectionDiv" class="tabDivMargin3 divBorder startHide secondDiv">
        ...
        <div id="Type2" class="form-group row startHide">
            ...
            <%--分析師/會員種類--%>
            <div class="col-xs-2">
                <label for="" class=""><span class="colorRed">*</span>分析師/會員種類：</label>
                <label class="">
            ...
            <%--入會時間--%>
                <div class="col-xs-6">
                    <label for="" class=""><span class="colorRed">*</span>入會日期12：</label>
                    <label class="">
        ...
        <div id="Type21" class="form-group row startHide">
            <%--入帳人員1--%>
            <div class="form-group row ">
              <label for="" class=""><span class="colorRed">*</span>【特殊件】</label>
                <%--入帳人員1--%>
              <div class="col-xs-14">
        ...
        <div id="Type44" class="form-group row startHide">
            ...
            <div class="col-xs-6">
                ...
                <input type="checkbox" id="fax" name="fax" class="form-check-input" />&nbsp;&nbsp;設-網路傳真&nbsp;&nbsp;
                            <label>
                ...
                <input type="checkbox" name="mess_other2" class="form-check-input" />&nbsp;&nbsp;不設&nbsp;&nbsp;
        ...
        <div id="Type5" class="form-group row startHide">
            <div class="col-xs-6">
                ...
                <input type="checkbox" id="mess_other3" name="mess_other3" value="1" class="form-check-input" />&nbsp;&nbsp;設&nbsp;&nbsp;
                        <label for="" class="">
                            <select id="abcMess3" class="form-control">
                                <option value="0001">一般</option>
                                <option value="0002">解盤</option>
                                <option value="0003">特別</option>
                                <option value="0004">飆股</option>
                                <option value="0005">專案</option>
                            </select>
                        </label>
                <input type="checkbox" id="mess_other4" name="mess_other4" value="2" class="form-check-input" />&nbsp;&nbsp;不設&nbsp;&nbsp;
        ...
        */
        ...
        var startThisPage = function () {
            ...
            onChange_M("#abcT_Type", function () {
                ...
                var Type21_Visible = document.getElementById("Type21");//特殊件-入帳人員
                Type21_Visible.style.display = 'block';
                alert("入會方式:" + SelectMP);
                //0001:一般
                //0002:會場
                //0003:特殊
