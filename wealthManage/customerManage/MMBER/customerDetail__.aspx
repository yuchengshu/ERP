...
<body style="font-family: Microsoft JhengHei;">
    ...
    <div id="addBusinessConnectionDiv" class="tabDivMargin3 divBorder startHide secondDiv">
        ...
        <form id="form1" class="form-group row marginTop10px">
            <%--客戶資料--%>
            ...
            <div id="Type2" class="form-group row startHide">
                <div id="openConnetTypeDiv0001" class="openConnetTypeDiv ">
                    <%--入會方式--%>
                    ...
                    <%--入會方式-一般件--%>
                    <div id="Type0001" class="form-group row startHide">
                    </div>
                    <%--入會方式-會場件--%>
                    <div id="Type0002" class="form-group row startHide">
                    </div>
                    <%--入會方式-特殊件--%>
            ...
            <div id="Type44" class="form-group row startHide">
                ...
                <div class="col-xs-6">
                    ...
                    <input type="checkbox" id="fax_Set" name="fax_Set" value="1" class="form-check-input" checked />&nbsp;&nbsp;設-網路傳真&nbsp;&nbsp;
                            <label>
                    ...
                    <input type="checkbox" id="unfax_Set" name="fax_Set" value="2" class="form-check-input" />&nbsp;&nbsp;不設&nbsp;&nbsp;
            ...
            <div id="Type5" class="form-group row startHide">
                <div class="col-xs-6">
                    ...
                    <input type="checkbox" id="mess_main" name="mess_main" value="1" class="form-check-input" checked />&nbsp;&nbsp;設&nbsp;&nbsp;
                        <label for="" class="">
                            <select id="Mess_Option" class="form-control">
                    ...
                    <input type="checkbox" id="mess_other" name="mess_main" value="2" class="form-check-input" />&nbsp;&nbsp;不設&nbsp;&nbsp;
    ...
    <script>
        ...
        */
        ...
        var startThisPage = function () {
            ...
            //限制[設傳真稿][設][不設]不能同時選
            $("input[name=fax_Set]").click(function () {
                var Selected1 = $(this).val();
                //alert('//限制[設傳真稿][設][不設]不能同時選');
                $("input[name=fax_Set]").each(function (i) {
                    if ($(this).val() == Selected1) $(this).prop("checked", true);
                    else $(this).prop("checked", false);
                });
            });
            //限制[設訊][設][不設]不能同時選
            $("input[name=mess_main]").click(function () {
                var Selected2 = $(this).val();
                //alert(' //限制[設訊][設][不設]不能同時選');
                $("input[name=mess_main]").each(function (i) {
                    if ($(this).val() == Selected2) $(this).prop("checked", true);
                    else $(this).prop("checked", false);
                });
            });
            //限制[設傳真稿][設][不設]不能同時選
            $("input[name=fax_Set]").click(function () {
                ...
                $("input[name=fax_Set]").each(function (i) {
                    if ($(this).val() == Selected3) $(this).prop("checked", true);
                    else $(this).prop("checked", false);
                });
            });
            var M_ID = "<%=getM_ID()%>";
        ...
        var comMdepChangeFuc_Transfer = function () {
            //var emp = $(this).attr("EMP");
            //var com = $(this).attr("Select_Com");//所選到的公司代號
            //var mdep = $(this).attr("U_MDEP");//所選到的部門代號
            alert('comMdepChangeFuc_Transfer!!!');
            var Select_Com_Transfer1 = val_M("#Select_Com_Transfer1");//所選的公司
            var Select_Dept_Transfer1 = val_M("#Select_Dept_Transfer1");//所選的部門
            alert("所選的公司:" + Select_Com_Transfer1);
            alert("所選的部門:" + Select_Dept_Transfer1);
            //var mdep = "/**************/"; //使用者部門代號
            //alert(Select_Com);
            //alert(Select_Dept);
            //$("#" + emp).empty();
            ...
            //var abcU_MDEPVal_Test = $("#" + mdep).val();
            //var url = CommonHandlerUrl_M;
            var data = "ComID=" + Select_Com_Transfer1 + "&U_MDEP=" + Select_Dept_Transfer1 + "&action=getSelectEmplist";
            var success = function (back) {
                var json = JSON.parse(back);
                var sb = new StringBuilder_M();
                //$(idOrClassName).empty();
        ...
        var comMdepChangeFuc_Sign = function () {
            ...
            //var com = $(this).attr("Select_Com");//所選到的公司代號
            //var mdep = $(this).attr("U_MDEP");//所選到的部門代號
            var Select_Com_Sign = val_M("#Select_Com_Transfer3");//所選的公司
            var Select_Dept_Sign = val_M("#Select_Dept_Transfer3");//所選的部門
            //var mdep = "/**************/"; //使用者部門代號
            //alert(Select_Com);
            //alert(Select_Dept);
            //$("#" + emp).empty();
        ...
        var afterSuccessFucMREGT01 = function () {
            ...
            var Select_Com_Transfer3 = val_M("#Select_Com_Transfer3");//所選的公司
            var Select_Dept_Transfer3 = val_M("#Select_Dept_Transfer3");//所選的部門
            ...
            $Common.MITEM.getMREGT02ListHtmlTagOption_3(CommonHandlerUrl_M, "#Select_Employ_Transfer3", Select_Com_Transfer3, Select_Dept_Transfer3, "option", afterSuccessFucMREGT03);//20221207進度(實做這個!!)
        ...
        var addBusinessConnection = function () {
            ...
            if (CF_Item == "0001") {
                ...
                var mess;
                //取得欄位資訊
                //var mess_main = $("#mess_main").val();//設訊[勾選]
                //var mess_main = document.getElementById("mess_main");//傳真稿(選項)傳真稿的選項代號
                //alert("設訊:" + mess_main);
                //var mess_other3_Check = document.getElementById("mess_main");
                //設傳真稿
                //var Fax_Check = document.getElementById("#fax_item");//設傳真稿
                //alert("設傳真稿是否勾選:" + Fax_Check.checked.toString());
                //var Fax_Option_Value = $('#fax_item').val();//設傳真稿的選項代號
                //alert('設傳真稿的選項代號:' + Fax_Option_Value);

                //var Mess_Check = document.getElementById("#mess_main");//設訊是否勾選
                //alert("設訊是否勾選:" + Mess_Check.checked.toString());
                //if (Mess_Check.toString() == "true") {
                //    mess = "1";
                //    var Mess_Option_Value = $('#Mess_Option').val();//設訊的選項代號
                //    mess = mess + "," + Mess_Option_Value;
                //    alert(mess);
                //};
                //var Mess_Option_Value = $('#Mess_Option').val();//設訊的選項代號
                //alert('設訊的選項代號:' + Mess_Option_Value);

                //var fax_item_value = document.getElementById("fax_item_value");//傳真稿(選項)傳真稿的選項代號
                //var mess_other3_Check_value = $(mess_main).children("option:selected").val();//設訊的選項代號
                //var fax_item_Check = document.getElementById("fax_item");//傳真稿(選項)傳真稿的選項是否勾選
                //alert(mess_other3_Check_value);
                //var mess_option = $("#mess_other3_Check").val();//設訊的選項代號
                ...
                var abcMess = $("#Mess_Option").val();//[設訊]選項
                var abcfax_item = $("#fax_item").val();//[傳真稿]項目
                var abcMess_Check = document.getElementById("mess_main");//設訊(設)
                //mess_other
                var abcMess_UNCheck = document.getElementById("mess_other");//設訊(不設)
                var fax_Set_Check = document.getElementById("fax_Set");
                var unfax_Set_Check = document.getElementById("unfax_Set");
                var abcMess_Check_String = abcMess_Check.checked.toString();
                var abcMess_Code = "";
                alert("設訊是否勾選20230728:" + abcMess_Check.checked.toString());
                alert("傳真稿是否勾選20230728" + fax_Set_Check.checked.toString());
                alert("設訊--[不設]是否勾選20230728:" + abcMess_UNCheck.checked.toString());
                alert("傳真稿--[不設]是否勾選20230728" + unfax_Set_Check.checked.toString());
                var MessCode;//設訊(總)
                var FaxCode;//傳真(總)
                //alert("設訊勾選項目代號20230728:" + abcMess.toString());
                //alert("傳真稿項目代號20230728:" + abcMess.toString());
                if (abcMess_Check_String == "true")//設訊有勾選
                {
                    MessCode = abcMess;
                }
                //var Mess_Option_Value = $("#Mess_Option").val();//設訊勾選項目代號
                //var Mess_Check = document.getElementById("mess_main");//設訊是否勾選*/
                var mess_other5_Check = document.getElementById("mess_other5");//業務自帶是否勾選
                var mess_other6_Check = document.getElementById("mess_other6");//特助或行政帶是否勾選
                //alert("設訊是否勾選:" + Mess_Check.checked.toString());//true[checkbox]
                //alert("設訊勾選的選項:" + Mess_Option_Value);
                //alert("業務自帶是否勾選:" + mess_other5_Check.checked.toString());//true[checkbox]
                var mess_other5_Check_String = mess_other5_Check.checked.toString();
                if (mess_other5_Check_String == "true") {
                    if (MessCode == "") {
                        MessCode += "3";//業務自帶
                    }
                    else {
                ...
                //alert("特助或行政帶是否勾選" + mess_other6_Check.checked.toString());//true[checkbox]
                var mess_other6_Check_String = mess_other6_Check.checked.toString();
                if (mess_other6_Check_String == "true") {
                    //MessCode += ",4";//特助或行政帶
                    if (MessCode == "") {
                        MessCode += "4";//業務自帶
                    }
                ...
                if (Mess_Check.checked.toString() == "true") {
                    mess = Mess_Option_Value;//設訊勾選項目代號
                }
                //業務自帶是否勾選
                ...
                alert("設訊[選項代號]:" + mess.toString());//0004
                ...
                //    alert("傳真稿[設-網路傳真]:勾選!!!")
                //}
                checkBox = document.getElementById('#mess_main');
                //if (checkBox.checked) {
                ...
                var fax2 = $("#fax_item").val();//傳真稿[設-網路傳真](選項代號)
                //傳真稿是否勾選
                var fax_Check = document.getElementById("fax_item");//傳真稿
                alert("傳真稿[設-網路傳真](是否勾選)" + fax_Check);
                checkBox = document.getElementById('fax');//mess_main
                if (fax_Check == "true") {
                    var FaxCode = fax2;//傳真稿[設-網路傳真](選項代號)
                }
                var FaxCode = fax2;
                alert("[傳真稿]選項編號:" + FaxCode);
                var fax_item2 = $("#abcfax_item").val();//傳真稿[設-網路傳真](選項)
                alert("傳真稿[設-網路傳真](選項):;設-網路傳真" + fax_item2);
                ...
                //var mess_option = "";//設訊
                //設訊是否勾選
                //if ($(mess_main).prop("checked") == true) {
                //    alert("設訊:設勾選!!");
                //}
                //if ($(mess_main).prop("checked") == true) {
                //    alert("設訊:設勾選!!");
                ...
                //var mess_main = $("#mess_main").val();//業務自帶
                ...
                alert("設鎖碼影音:" + Media.toString());
                //設付費文章[P_Text]
                var P_text = $("#P_text").val();//設付費文章
                alert("設付費文章:" + P_text.toString());
                //設付費影片[P_video]
                var P_video = $("#P_video").val();//設付費影片
                alert("設付費影片:" + P_video.toString());
                //ATM後五碼
            ...
            //暫停/恢復
                ...
                alert("設訊:" + mess_main);
                //var mess_other3_Check = document.getElementById("mess_main");
                var mess_other3_Check_Value = $('#mess_main').val();
                var fax_item_value = document.getElementById("fax_item_value");//傳真稿(選項)傳真稿的選項代號
                var mess_other3_Check_value = $(mess_main).children("option:selected").val();//傳真稿(選項)傳真稿的選項代號
                ...
                //var abcMess_Check = document.getElementById("mess_main");
                ...
                //傳真稿是否勾選
                var fax_Check = document.getElementById("fax");
                if (fax_Check.checked) {
                    alert("傳真稿[設-網路傳真](選項代號):" + fax2);
                }
            ...
            //轉換老師
                ...
                //alert("Mess:" + abcMess3.checked.toString());
                //設訊是否勾選//abcMess3
                var abcMess = $("#Mess_Option").val();
                alert("設訊勾選的選項項目:" + abcMess);
                var abcMess_Check = document.getElementById("mess_main");
                alert('設訊是否勾選:' + abcMess_Check.checked);
                //fax_Set
                var abcFax_Check = document.getElementById("fax_Set");
                alert('傳真稿是否勾選:' + abcFax_Check.checked);
                //alert("設訊是否勾選:" + abcMess_Check.checked.toString());
                //alert("設訊勾選項目代號:" + abcMess.toString());
                //alert("設訊[選項代號]" + abcMess3);
                //設訊是否勾選
                ...
                case "0001":
                    ...
                    if (PT_Item == "1")//單筆(付款類型)
                    {
                        ...
                        data = "action=addBusinessConnection"
                            ...
                            + "&Select_Dept=" + Select_Dept +//簽核主管-部門
                            + "&Select_Employ=" + Select_Employ +//簽核主管-員工編號
                            + "begindate_Date=" + begindate_Date +
                            + "enddate_Date=" + bcenddate_Date +
                            + "ca_id=" + ca_id +
                            + "CellPhone=" + CellPhone +
                            + "Fax=" + fax2 +
                            + "Mess=" +
        ...
        var startPage2 = function () {
            ...
            $(".comMdepChangeFuc_Transfer").on("change", comMdepChangeFuc_Transfer);
