<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MMBER_query.aspx.cs" Inherits="wealthManage_custermerManage_MMBER_customerManage" %>
            ...
            <div class="col-md-12">
                <div class="box box-danger">
                    <div class="box-header">
                        ...
                        <h1 class="box-title"><b>ERP > 客戶管理  > 客戶管理</b> </h1>
                            ...
                            <thead>
                                <tr class="active">
                                  ...
                                  <tr class ="bgBlue">
                                    ...
                                    <th class="" style="width: 17%;text-align:center;">公司電話</th>
                                    <th class="" style="width: 17%;text-align:center;">住家電話</th>
                                      <th class="" style="width: 17%;text-align:center;">會期中產品</th>
...
　                        <div id="pageBar" style="margin:0 auto;"></div>
   ...
   <script>
       var CustomerManageHandlerUrl_G = "MMBER_queryHandler.ashx";
