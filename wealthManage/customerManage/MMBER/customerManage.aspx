<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="customerManage.aspx.cs" Inherits="wealthManage_custermerManage_MMBER_customerManage" %>
                ...
                <div class="col-md-12">
                    <div class="box box-danger">
                        <div class="box-header">
                            ...
                            <h1 class="box-title"><b>ERP > 財富管理部 > 客戶管理</b> </h1>
                            ...
                            <table class="table table-hover" id="customerDataTab">
                                <thead>
                                    ...
                                    <tr class="bgBlue">
                                        ...
                                        <th class="" style="width: 4%; text-align: center;">狀態</th>
                                        <th class="" style="width: 6%; text-align: center;">姓名</th>
                                        <th class="" style="width: 4%; text-align: center;">性別</th>
                                        <th class="" style="width: 11%; text-align: center;">助理</th>
                                        <th class="" style="width: 17%; text-align: center;">手機</th>
                                        <th class="" style="width: 12%; text-align: center;">公司電話</th>
                                        <th class="" style="width: 12%; text-align: center;">住家電話</th>
                                        <th class="" style="width: 10%; text-align: center;">會期中產品</th>
                                        <th class="" style="width: 20%; text-align: center;">建檔日</th>
            ...
            if (CustomerDataJson_G.length != 0) {
                ...
                $.each(CustomerDataJson_G, function (i, v) {
                    ...
                    if (n >= startCount && n <= endCount) {
                        ...
                        if (v.Light_Status == "R") {
                            sb.append("<span><img src='\\..\\..\\..\\img\\icon\\Red_Light.png' width=15 height=15>");
                        } else if (v.Light_Status == "Y") {
                            sb.append("<span><img src='\\..\\..\\..\\img\\icon\\Yellow_Light.png' width=15 height=15>");
                        ...
                        sb.append("</th><th class='text-center'>");
                        //20220720
                        sb.append(v.Production);//會期中產品(Production)
                        sb.append("</th>");
                        sb.append("</th><th class='text-center'>");
